...
if (isset($_GET['page']) && !empty($_POST)) {
	...
	if ('export_personal_data' === $_GET['page']) {
		require_once ABSPATH . '4dm1n/export-personal-data.php';
		return;
	} elseif ('remove_personal_data' === $_GET['page']) {
		require_once ABSPATH . '4dm1n/erase-personal-data.php';
		return;
	}
}

// The privacy policy guide used to be outputted from here. Since WP 5.3 it is in 4dm1n/privacy-policy-guide.php.
