	...
	<form method="post" action="options.php">
		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					<fieldset>
						<legend class="screen-reader-text"><span><?php _e('Default post settings'); ?></span></legend>
			...
			<tr>
				...
				<td>
					<fieldset>
						<legend class="screen-reader-text"><span><?php _e('Disallowed Comment Keys'); ?></span></legend>
