...
if (get_option('db_upgraded')) {
	 ...
	 *
	 * In single site, the user would be redirected to 4dm1n/upgrade.php.
	...
	if (apply_filters('do_mu_upgrade', true)) {
		...
		if ($c <= 50 || ($c > 50 && mt_rand(0, (int) ($c / 50)) === 1)) {
			...
			/** This action is documented in 4dm1n/network/upgrade.php */
...
require_once ABSPATH . '4dm1n/includes/admin.php';
 ...
 * $wp_importers is sometimes set in 4dm1n/includes/import.php
...
if (WP_NETWORK_ADMIN) {
	require ABSPATH . '4dm1n/network/menu.php';
} elseif (WP_USER_ADMIN) {
	require ABSPATH . '4dm1n/user/menu.php';
} else {
	require ABSPATH . '4dm1n/menu.php';
}
...
if (isset($plugin_page)) {
	...
	require_once ABSPATH . '4dm1n/includes/upgrade.php';
