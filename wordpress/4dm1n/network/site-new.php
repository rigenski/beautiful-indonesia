...
require_once ABSPATH . '4dm1n/includes/translation-install.php';
		...
		<table class="form-table" role="presentation">
			...
			<tr class="form-field">
				<td colspan="2" class="td-full">
					<p id="site-admin-email"><?php _e('A new user will be created if the above email address is not in the database.'); ?><br /><?php _e('The username and a link to set the password will be mailed to this email address.'); ?></p>
				</td>
			</tr>
		</table>
