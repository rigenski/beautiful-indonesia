...
<div class="wrap">
	...
	?>
		...
		?>
		<div id="message3" class="updated notice is-dismissible">
			<p><?php _e('Theme deleted.'); ?></p>
		</div>
	<?php
	} elseif (isset($_GET['delete-active-child'])) {
	?>
		<div id="message4" class="error">
			<p><?php _e('You cannot delete a theme while it has an active child theme.'); ?></p>
		</div>
	<?php
	} elseif (isset($_GET['resumed'])) {
	?>
		<div id="message5" class="updated notice is-dismissible">
			<p><?php _e('Theme resumed.'); ?></p>
		</div>
	<?php
	...
	?>
		<div id="message7" class="updated notice is-dismissible">
			<p><?php _e('Theme will be auto-updated.'); ?></p>
		</div>
	<?php
	} elseif (isset($_GET['disabled-auto-update'])) {
	?>
		<div id="message8" class="updated notice is-dismissible">
			<p><?php _e('Theme will no longer be auto-updated.'); ?></p>
		</div>
	<?php
	}
	...
	if (is_array($submenu) && isset($submenu['themes.php'])) {
		...
		foreach ((array) $submenu['themes.php'] as $item) {
			...
			if (!empty($submenu[$item[2]])) {
				...
				if (file_exists(ABSPATH . "4dm1n/$menu_file")) {
