 ...
 * 2. Not all core admin classes are filterable, notably: 4dm1n, wp-core-ui,
...
<body class="4dm1n wp-core-ui no-js <?php echo $admin_body_classes; ?>">
	<script type="text/javascript">
	...
	<div id="wpwrap">
		<?php require ABSPATH . '4dm1n/menu-header.php'; ?>
		<div id="wpcontent">
			...
			<div id="wpbody" role="main">
				...
				<div id="wpbody-content">
					...
					if ('options-general.php' === $parent_file) {
						require ABSPATH . '4dm1n/options-head.php';
					}
