...
require_once ABSPATH . '4dm1n/includes/class-walker-category-checklist.php';

/** WP_Internal_Pointers class */
require_once ABSPATH . '4dm1n/includes/class-wp-internal-pointers.php';
...
?>
	...
	<?php
	/** This action is documented in 4dm1n/admin-header.php */
	...
	/** This filter is documented in 4dm1n/admin-header.php */
	$admin_body_classes = apply_filters('admin_body_class', '');
	$admin_body_classes = ltrim($admin_body_classes . ' ' . $admin_body_class);
	?>

	<body <?php echo $admin_body_id; ?>class="4dm1n wp-core-ui no-js iframe <?php echo $admin_body_classes; ?>">
		<script type="text/javascript">
			(function() {
...
function iframe_footer()
{
	...
	?>
		<div class="hidden">
			<?php
			/** This action is documented in 4dm1n/admin-footer.php */
...
?>
	<!DOCTYPE html>
	<html class="<?php echo $admin_html_class; ?>" <?php
													/**
