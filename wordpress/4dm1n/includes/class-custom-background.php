							...
							<td>
								<form enctype="multipart/form-data" id="upload-form" class="wp-upload-form" method="post">
									...
									<p>
										...
										<button id="choose-from-library-link" class="button" data-choose="<?php esc_attr_e('Choose a Background Image'); ?>" data-update="<?php esc_attr_e('Set as background'); ?>"><?php _e('Choose Image'); ?></button>
									</p>
								</form>
							</td>
						</tr>
					...
					<tbody>
						<?php if (get_background_image()) : ?>
							...
							<tr>
								...
								<td>
									<fieldset>
										<legend class="screen-reader-text"><span><?php _ex('Repeat', 'Background Repeat'); ?></span></legend>
							...
							<tr>
								...
								<td>
									<fieldset>
										<legend class="screen-reader-text"><span><?php _ex('Scroll', 'Background Scroll'); ?></span></legend>
...
<?php
	...
	public function handle_upload()
	{
		...
		/** This action is documented in 4dm1n/includes/class-custom-image-header.php */
