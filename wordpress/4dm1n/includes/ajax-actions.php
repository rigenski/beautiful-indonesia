...
function wp_ajax_imgedit_preview()
{
	...
	include_once ABSPATH . '4dm1n/includes/image-edit.php';
...
function wp_ajax_autocomplete_user()
{
	...
	/** This filter is documented in 4dm1n/user-new.php */
...
function wp_ajax_add_tag()
{
	...
	require ABSPATH . '4dm1n/includes/edit-tag-messages.php';
...
function wp_ajax_add_menu_item()
{
	...
	require_once ABSPATH . '4dm1n/includes/nav-menu.php';
	...
	/** This filter is documented in 4dm1n/includes/nav-menu.php */
...
function wp_ajax_inline_save()
{
	...
	if (!empty($data['tax_input'])) {
		foreach ($data['tax_input'] as $taxonomy => $terms) {
			...
			/** This filter is documented in 4dm1n/includes/class-wp-posts-list-table.php */
...
function wp_ajax_save_widget()
{
	...
	/** This action is documented in 4dm1n/widgets.php */
...
function wp_ajax_delete_inactive_widgets()
{
	...
	/** This action is documented in 4dm1n/includes/ajax-actions.php */
	do_action('load-widgets.php'); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
	/** This action is documented in 4dm1n/includes/ajax-actions.php */
	do_action('widgets.php'); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
	/** This action is documented in 4dm1n/widgets.php */
...
{
	require ABSPATH . '4dm1n/includes/revision.php';
...
function wp_ajax_query_themes()
{
	...
	/** This filter is documented in 4dm1n/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image()
{
	...
	switch ($context) {
		case 'site-icon':
			...
			/** This filter is documented in 4dm1n/includes/class-custom-image-header.php */
...
function wp_ajax_install_theme()
{
	...
	require_once ABSPATH . '4dm1n/includes/class-wp-upgrader.php';
	include_once ABSPATH . '4dm1n/includes/theme.php';
...
function wp_ajax_install_plugin()
{
	...
	require_once ABSPATH . '4dm1n/includes/class-wp-upgrader.php';
	include_once ABSPATH . '4dm1n/includes/plugin-install.php';
...
function wp_ajax_health_check_dotorg_communication()
{
	...
	if (!class_exists('WP_Site_Health')) {
		require_once ABSPATH . '4dm1n/includes/class-wp-site-health.php';
	}
...
function wp_ajax_health_check_get_sizes()
{
	...
	if (!class_exists('WP_Debug_Data')) {
		require_once ABSPATH . '4dm1n/includes/class-wp-debug-data.php';
	}
...
function wp_ajax_toggle_auto_updates()
{
	...
	switch ($type) {
		case 'plugin':
			...
			/** This filter is documented in 4dm1n/includes/class-wp-plugins-list-table.php */
