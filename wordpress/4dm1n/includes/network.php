...
?>
	...
	?>
		...
		<p><?php _e('Please choose whether you would like sites in your WordPress network to use sub-domains or sub-directories.'); ?>
			<strong><?php _e('You cannot change this later.'); ?></strong>
		</p>
...
function network_step2($errors = false)
{
	...
	?>
		...
		?>
			<div class="error">
				<p><strong><?php _e('Warning:'); ?></strong> <?php _e('An existing WordPress network was detected.'); ?></p>
			</div>
        ...
        <rewrite>
			...
			$web_config_file .= '
                <rule name="WordPress Rule 2" stopProcessing="true">
                    <match url="^' . $iis_subdir_match . '4dm1n$" ignoreCase="false" />
                    <action type="Redirect" url="' . $iis_subdir_replacement . '4dm1n/" redirectType="Permanent" />
                </rule>
...
{$ms_files_rewriting}
# add a trailing slash to /4dm1n
RewriteRule ^{$subdir_match}4dm1n$ {$subdir_replacement_01}4dm1n/ [R=301,L]
