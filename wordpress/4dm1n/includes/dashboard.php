...
function wp_dashboard_setup()
{
	...
	if (
		$response && isset($response['is_acceptable']) && !$response['is_acceptable']
	...
	if ('POST' === $_SERVER['REQUEST_METHOD'] && isset($_POST['widget_id'])) {
		...
		ob_start(); // Hack - but the same hack 4dm1n/widgets.php uses.
...
?>
	...
	<form name="post" action="<?php echo esc_url(admin_url('post.php')); ?>" method="post" id="quick-press" class="initial-form hide-if-no-js">
		...
		<div class="input-text-wrap" id="title-wrap">
			<label for="title">
				<?php
				/** This filter is documented in 4dm1n/edit-form-advanced.php */
 ...
 * which is later replaced by Ajax call (see top of /4dm1n/index.php)
 *
 * @since 2.5.0
