...
class WP_Site_Health
{
	...
	{
		if ('debug' === $tab) {
			require_once ABSPATH . '/4dm1n/site-health-info.php';
		}
	}
	...
	public function get_test_background_updates()
	{
		...
		if (!class_exists('WP_Site_Health_Auto_Updates')) {
			require_once ABSPATH . '4dm1n/includes/class-wp-site-health-auto-updates.php';
		}
	...
	public static function get_tests()
	{
		 ...
		 * to complete should run asynchronously, to avoid extended loading periods within 4dm1n.
		 *
		 * @since 5.2.0
	...
	{
		// Bootstrap 4dm1n, as WP_Cron doesn't do this for us.
		require_once trailingslashit(ABSPATH) . '4dm1n/includes/admin.php';
