...
{
?>
	<label class="screen-reader-text" for="excerpt"><?php _e('Excerpt'); ?></label><textarea rows="1" cols="40" name="excerpt" id="excerpt"><?php echo $post->post_excerpt; // textarea_escaped 
																																				?></textarea>
	<p>
		<?php
		printf(
...
{
	/** This filter is documented in 4dm1n/edit-tag-form.php */
...
function link_submit_meta_box($link)
{
	...
	<div class="submitbox" id="submitlink">
		...
		<div id="major-publishing-actions">
			<?php
			/** This action is documented in 4dm1n/includes/meta-boxes.php */
...
?>
	<table class="links-table">
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span><?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('identity'); ?></span></legend>
					<label for="me">
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span><?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('friendship'); ?></span></legend>
					<label for="contact">
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span><?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('physical'); ?></span></legend>
					<label for="met">
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span><?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('professional'); ?></span></legend>
					<label for="co-worker">
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span> <?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('geographical'); ?> </span></legend>
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span> <?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('family'); ?> </span></legend>
					<label for="child">
		...
		<tr>
			...
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span> <?php /* translators: xfn: https://gmpg.org/xfn/ */ _e('romantic'); ?> </span></legend>
					<label for="muse">
...
?>
	<table class="links-table" cellpadding="0">
		...
		<tr>
			...
			<td><textarea name="link_notes" id="link_notes" rows="10"><?php echo (isset($link->link_notes) ? $link->link_notes : ''); // textarea_escaped 
																		?></textarea></td>
		</tr>
		<tr>
