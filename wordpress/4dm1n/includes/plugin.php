...
function add_submenu_page($parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '', $position = null)
{
	 ...
	 * See 4dm1n/admin.php for redirect from edit.php to tools.php.
	 */
 ...
 *
 * @since 3.0.0
 * @since 4.4.0 Function was moved into the `4dm1n/includes/plugin.php` file.
 *
 * @param string $plugin Path to the plugin file relative to the plugins directory.
 */
	...
	if (!is_admin()) {
		_doing_it_wrong(
			...
			sprintf(
				...
				__('The suggested privacy policy content should be added only in 4dm1n by using the %s (or later) action.'),
