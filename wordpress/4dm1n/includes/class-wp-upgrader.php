...
require_once ABSPATH . '4dm1n/includes/class-plugin-upgrader.php';

/** Theme_Upgrader class */
require_once ABSPATH . '4dm1n/includes/class-theme-upgrader.php';

/** Language_Pack_Upgrader class */
require_once ABSPATH . '4dm1n/includes/class-language-pack-upgrader.php';

/** Core_Upgrader class */
require_once ABSPATH . '4dm1n/includes/class-core-upgrader.php';

/** File_Upload_Upgrader class */
require_once ABSPATH . '4dm1n/includes/class-file-upload-upgrader.php';

/** WP_Automatic_Updater class */
require_once ABSPATH . '4dm1n/includes/class-wp-automatic-updater.php';
