				...
				case 'post':
					...
					if ($post_id) {
						...
						if ($post) {
							...
							/** This filter is documented in 4dm1n/post.php */
...
?>
	...
	public function render_per_page_options()
	{
		...
		if ('edit_comments_per_page' === $option) {
			...
			/** This filter is documented in 4dm1n/includes/class-wp-comments-list-table.php */
			$per_page = apply_filters('comments_per_page', $per_page, $comment_status);
		} elseif ('categories_per_page' === $option) {
			/** This filter is documented in 4dm1n/includes/class-wp-terms-list-table.php */
			$per_page = apply_filters('edit_categories_per_page', $per_page);
		} else {
			/** This filter is documented in 4dm1n/includes/class-wp-list-table.php */
			$per_page = apply_filters("{$option}", $per_page);
		}

		// Back compat.
		if (isset($this->post_type)) {
			/** This filter is documented in 4dm1n/includes/post.php */
	...
	?>
		<fieldset class="screen-options">
			...
			<?php if ($per_page_label) : ?>
				...
				<input type="number" step="1" min="1" max="999" class="screen-per-page" name="wp_screen_options[value]" id="<?php echo esc_attr($option); ?>" maxlength="3" value="<?php echo esc_attr($per_page); ?>" />
			<?php endif; ?>
