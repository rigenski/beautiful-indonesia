...
function the_media_upload_tabs()
{
	...
	if (!empty($tabs)) {
		...
		if (isset($redir_tab) && array_key_exists($redir_tab, $tabs)) {
			...
			/** This filter is documented in 4dm1n/media-upload.php */
	...
	*/
	 ...
	 */
		...
		<script type="text/javascript">
			...
			?>
			var resize_height = <?php echo $large_size_h; ?>,
				resize_width = <?php echo $large_size_w; ?>,
			...
			<script type="text/javascript">
				var addExtImage = {
					...
					getImageData: function() {
						...
						var t = addExtImage,
							src = document.forms[0].src.value;
	...
	function edit_form_image_editor($post)
	{
		...
		if ($open) {
			require_once ABSPATH . '4dm1n/includes/image-edit.php';
		}
