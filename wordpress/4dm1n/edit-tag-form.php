...
require_once ABSPATH . '4dm1n/includes/edit-tag-messages.php';
...
<div class="wrap">
	...
	<form name="edittag" id="edittag" method="post" action="edit-tags.php" class="validate" <?php
		...
		<table class="form-table" role="presentation">
			<tr class="form-field form-required term-name-wrap">
				...
				<td><input name="name" id="name" type="text" value="<?php echo $tag_name_value; ?>" size="40" aria-required="true" />
					<p class="description"><?php echo $tax->labels->name_field_description; ?></p>
				</td>
			</tr>
			<?php if (!global_terms_enabled()) { ?>
				<tr class="form-field term-slug-wrap">
					...
					<td><input name="slug" id="slug" type="text" value="<?php echo esc_attr($slug); ?>" size="40" />
						<p class="description"><?php echo $tax->labels->slug_field_description; ?></p>
					</td>
				</tr>
			<?php } ?>
			<?php if (is_taxonomy_hierarchical($taxonomy)) : ?>
				<tr class="form-field term-parent-wrap">
					...
					<td>
						...
						/** This filter is documented in 4dm1n/edit-tags.php */
			...
			<tr class="form-field term-description-wrap">
				...
				<td><textarea name="description" id="description" rows="5" cols="50" class="large-text"><?php echo $tag->description; // textarea_escaped 
																										?></textarea>
					<p class="description"><?php echo $tax->labels->desc_field_description; ?></p>
				</td>
			</tr>
			<?php
			// Back compat hooks.
		...
		// Back compat hooks.
		if ('category' === $taxonomy) {
			/** This action is documented in 4dm1n/edit-tags.php */
