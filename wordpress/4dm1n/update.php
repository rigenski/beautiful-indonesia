...
if (isset($_GET['action'])) {
	...
	if ('update-selected' === $action) {
		...
		include_once ABSPATH . '4dm1n/includes/plugin-install.php'; // For plugins_api().
		...
		include_once ABSPATH . '4dm1n/includes/class-wp-upgrader.php'; // For themes_api().
		 ...
		 * provided in the request for 4dm1n/update.php. Can be used to
