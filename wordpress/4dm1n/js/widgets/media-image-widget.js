/**
 * @output 4dm1n/js/widgets/media-image-widget.js
 */
    ...
    /** @lends wp.mediaWidgets.controlConstructors.media_image.prototype */ {
      ...
      editMedia: function editMedia() {
        ...
        updateCallback = function () {
          ...
          control.model.set(
            _.extend(control.mapMediaToModelProps(mediaProps), { error: false })
          );
        };
      ...
      mapModelToPreviewTemplateProps:
        function mapModelToPreviewTemplateProps() {
          ...
          previewTemplateProps =
            component.MediaWidgetControl.prototype.mapModelToPreviewTemplateProps.call(
              control
            );
