...
!(function (o) {
  ...
  function v() {
    var s;
    (e = o(".user-pass1-wrap, .user-pass-wrap, .reset-pass-submit")),
      o(".user-pass2-wrap").hide(),
      (p = o("#submit, #wp-submit").on("click", function () {
        u = !1;
      })),
      (d = p.add(" #createusersub")),
      (n = o(".pw-weak")),
      ...
      (a = o("#pass1")).length
        ? ((l = a.val()),
          ...
          a.on("input pwupdate", function () {
            a.val() !== l &&
              ((l = a.val()), a.removeClass("short bad good strong"), b());
          }))
        : (a = o("#user_pass")),
  ...
  function b() {
    var s = o("#pass-strength-result")[0];
    s.className &&
  ...
  o(function () {
    var s,
      ...
      i = o("#display_name"),
      e = i.val(),
      r = o("#admin-bar-my-account").find(".display-name");
    o("#pass1").val("").on("input pwupdate", g),
      ...
      o("#generate-reset-link").on("click", function () {
        ...
        s = wp.ajax.post("send-password-reset", s);
        s.done(function (s) {
          m(e, !0, s);
        }),
          s.fail(function (s) {
