...
jQuery(function ($) {
  var stamp,
    ...
    isMac = window.navigator.platform
      ...
      : false,
    copyAttachmentURLClipboard = new ClipboardJS(
      ".copy-attachment-url.edit-media"
    ),
  ...
  $(".categorydiv").each(function () {
    ...
    if (getUserSetting(settingName))
      $('a[href="#' + taxonomy + '-pop"]', "#" + taxonomy + "-tabs").trigger(
        "click"
      );
    ...
    $("#" + taxonomy + "-add-toggle").on("click", function (e) {
      ...
      $('a[href="#' + taxonomy + '-all"]', "#" + taxonomy + "-tabs").trigger(
        "click"
      );
      $("#new" + taxonomy).trigger("focus");
    });
  ...
  if ($("#submitdiv").length) {
    ...
    updateText = function () {
      ...
      $("#post-status-display").text(
        ...
        wp.sanitize.stripTagsAndEncodeText(
          $("option:selected", postStatus).text()
        )
      );
    ...
    $postVisibilitySelect
      ...
      .on("click", function (event) {
        ...
        var visibilityLabel = "",
          selectedVisibility = $postVisibilitySelect
