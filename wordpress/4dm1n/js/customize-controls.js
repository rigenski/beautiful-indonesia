/**
 * @output 4dm1n/js/customize-controls.js
 */
...
(function (exports, $) {
  ...
  var reducedMotionMediaQuery = window.matchMedia(
  ...
  api.requestChangesetUpdate = function requestChangesetUpdate(changes, args) {
    ...
    _.each(
      api.dirtyValues({ unsaved: true }),
      function (dirtyValue, settingId) {
    ...
    /** @lends wp.customize~Container.prototype */ {
      ...
      setupNotifications: function () {
        ...
        container.notifications.container =
          container.getNotificationsContainerElement();
    ...
    /** @lends wp.customize.ThemesSection.prototype */ {
      ...
      renderScreenshots: function () {
        ...
        if (
          ...
          section.screenshotQueue = _.filter(
            section.controls(),
            function (control) {
  ...
  api.Control = api.Class.extend(
    /** @lends wp.customize.Control.prototype */ {
      ...
      renderContent: function () {
        ...
        control.notifications.container =
    ...
    /** @lends wp.customize.HeaderControl.prototype */ {
      ready: function () {
        ...
        new api.HeaderTool.ChoiceListView({
          collection: (api.HeaderTool.UploadsList =
            new api.HeaderTool.ChoiceList()),
          el: "#customize-control-header_image .choices .uploaded .list",
        });

        new api.HeaderTool.ChoiceListView({
          collection: (api.HeaderTool.DefaultsList =
            new api.HeaderTool.DefaultsList()),
          el: "#customize-control-header_image .choices .default .list",
        });

        api.HeaderTool.combinedList = api.HeaderTool.CombinedList =
          new api.HeaderTool.CombinedList([
      ...
      getInitialHeaderImage: function () {
        ...
        var currentHeaderObject = _.find(
          _wpCustomizeHeader.uploads,
          function (imageObj) {
            return (
              imageObj.attachment_id ===
              api.get().header_image_data.attachment_id
            );
          }
        );
  ...
  $(function () {
            ...
            api.each(function (setting) {
              setting.notifications.each(function (notification) {
                if ("error" === notification.type && !notification.fromServer) {
                  ...
                  settingInvalidities[setting.id][notification.code] =
                    notification;
                }
              });
            });
    ...
    (function checkAndDisplayLockNotice() {
      ...
      $(document).on(
        "heartbeat-send.update_lock_notice",
        function (event, data) {
      ...
      $(document).on(
        "heartbeat-tick.update_lock_notice",
        function (event, data) {
          var notification,
