/**
 * @output 4dm1n/js/customize-widgets.js
 */
...
(function (wp, $) {
      ...
      _setupRemoveUI: function () {
        ...
        $removeBtn.on("click", function () {
          ...
          self.container.slideUp(function () {
            var sidebarsWidgetsControl =
                api.Widgets.getSidebarWidgetControlContainingWidget(
                  self.params.widget_id
                ),
              sidebarWidgetIds,
              i;
      ...
      _setupModel: function () {
        ...
        this.setting.bind(function (newWidgetIds, oldWidgetIds) {
          ...
          widgetFormControls = _(newWidgetIds).map(function (widgetId) {
            var widgetFormControl =
              api.Widgets.getWidgetFormControlForWidget(widgetId);
          ...
          _(removedWidgetIds).each(function (removedWidgetId) {
            ...
            setTimeout(function () {
              ...
              removedControl =
                api.Widgets.getWidgetFormControlForWidget(removedWidgetId);
  ...
  api.bind("ready", function () {
    ...
    api.Widgets.availableWidgetsPanel =
      new api.Widgets.AvailableWidgetsPanelView({
