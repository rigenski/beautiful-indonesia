/**
 * @output 4dm1n/js/customize-nav-menus.js
 */
...
(function (api, wp, $) {
      ...
      _setupRemoveUI: function () {
        ...
        $removeBtn.on("click", function () {
          ...
          _.each(addedItems, function (addedItem) {
            ...
            if (
              menuItemControl &&
              deleteItemOriginalItemId ==
                menuItemControl.params.original_item_id
            ) {
              instanceCounter++;
            }
          });
          ...
          if (instanceCounter <= 1) {
            ...
            availableMenuItem = $(
              "#menu-item-tpl-" + control.params.original_item_id
            );
            availableMenuItem.removeClass("selected");
            availableMenuItem
              .find(".menu-item-handle")
              .removeClass("item-added");
          }
    ...
    /** @lends wp.customize.Menus.MenuControl.prototype */ {
      ...
      _setupSortable: function (menuList) {
        ...
        menuList.on("sortstop", function () {
          setTimeout(function () {
            // Next tick.
            var menuItemContainerIds =
                control.$sectionContent.sortable("toArray"),
              menuItemControls = [],
              position = 0,
              priority = 10;
  ...
  api.bind("ready", function () {
    ...
    api.Menus.availableMenuItemsPanel =
      new api.Menus.AvailableMenuItemsPanelView({
