  ...
  api = window.wpNavMenu = {
    ...
    moveMenuItem: function ($this, dir) {
      var items,
        ...
        a11ySpeech =
          menus["moved" + dir.charAt(0).toUpperCase() + dir.slice(1)];
    ...
    initAccessibility: function () {
      ...
      menu.on("click", ".menus-move", function () {
        ...
        if ("undefined" !== typeof dir) {
          api.moveMenuItem(
            $(this).parents("li.menu-item").find("a.item-edit"),
            dir
          );
        }
      });
    ...
    refreshAdvancedAccessibilityOfItem: function (itemToRefresh) {
      ...
      var thisLink,
        ...
        hasSameDepthSibling = menuItem.nextAll(
      ...
      if (isPrimaryMenuItem) {
        ...
        (parentItem = menuItem
          ...
          (itemPosition =
            $(subItems.parents(".menu-item").get().reverse()).index(menuItem) +
            1);
      ...
      $("#menu-to-edit").on(
        ...
        function (e) {
          ...
          if (title) {
            ...
            titleEl
              .text(
                wp.i18n._x("(no label)", "missing menu item navigation label")
              )
              .addClass("no-title");
          }
        }
    ...
    disableBulkSelection: function () {
      ...
      if (
        $(".menu-items-delete").is(
          '[aria-describedby="pending-menu-items-to-delete"]'
        )
      ) {
    ...
    attachMenuItemDeleteButton: function () {
      ...
      $(document).on("click", ".menu-items-delete", function (e) {
        ...
        if (!$(this).hasClass("disabled")) {
          ...
          deletionSpeech = menus.itemsDeleted.replace(
            "%s",
            itemsPendingDeletion
          );
      ...
      $("#menu-settings-column").on("click", function (e) {
        ...
        if (target.hasClass("nav-tab-link")) {
          ...
          if (selectAreaMatch) {
            ...
            selectAll = $(
              '.button-controls[data-items-type="' +
                selectAreaMatch +
                '"] .select-all'
            );
