 ...
 *
 * @output 4dm1n/js/site-health.js
 */
        ...
        if ("undefined" !== typeof this.has_rest && this.has_rest) {
          wp.apiRequest({
            ...
            .done(function (response) {
              /** This filter is documented in 4dm1n/includes/class-wp-site-health.php */
              appendIssue(
                wp.hooks.applyFilters("site_status_test_result", response)
              );
            })
          ...
          $.post(ajaxurl, data)
            .done(function (response) {
              /** This filter is documented in 4dm1n/includes/class-wp-site-health.php */
              appendIssue(
                wp.hooks.applyFilters("site_status_test_result", response.data)
              );
            })
            .fail(function (response) {
              var description;
