		...
		<?php if (!get_pages()) : ?>
			...
			<table class="form-table" role="presentation">
						...
						<td id="front-static-pages">
							<fieldset>
								...
								<?php if ('page' === get_option('show_on_front') && get_option('page_for_posts') === get_option('page_on_front')) : ?>
									<div id="front-page-warning" class="notice notice-warning inline">
								...
								<?php if (get_option('wp_page_for_privacy_policy') === get_option('page_for_posts') || get_option('wp_page_for_privacy_policy') === get_option('page_on_front')) : ?>
									<div id="privacy-policy-page-warning" class="notice notice-warning inline">
				...
				<tr>
					...
					<td>
						<fieldset>
							<legend class="screen-reader-text"><span><?php _e('For each post in a feed, include'); ?> </span></legend>
							<p>
