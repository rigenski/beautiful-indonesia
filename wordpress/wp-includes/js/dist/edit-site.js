this["wp"] = this["wp"] || {};
this["wp"]["editSite"] = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ B9Az: /***/ function (
      ...
      const pencil = Object(external_wp_element_["createElement"])(
      ...
      /* harmony default export */ var edit = (__webpack_exports__["a"] =
        library_pencil);
    ...
    /***/ IqXm: /***/ function (
      ...
      __webpack_require__.d(
        ...
        function () {
          return /* reexport */ navigation_toggle;
        }
      );
      __webpack_require__.d(__webpack_exports__, "PluginSidebar", function () {
        return /* reexport */ PluginSidebarEditSite;
      });
      __webpack_require__.d(
        __webpack_exports__,
      ...
      __webpack_require__.d(
        ...
        "setTemplatePart",
        function () {
          return actions_setTemplatePart;
        }
      );
      __webpack_require__.d(
        actions_namespaceObject,
        "setHomeTemplateId",
        function () {
          return setHomeTemplateId;
        }
      );
      __webpack_require__.d(actions_namespaceObject, "setPage", function () {
        return actions_setPage;
      });
      __webpack_require__.d(
        actions_namespaceObject,
        "setNavigationPanelActiveMenu",
        function () {
          return setNavigationPanelActiveMenu;
        }
      );
      __webpack_require__.d(
        actions_namespaceObject,
        ...
        function () {
          return openNavigationPanelToMenu;
        }
      );
      __webpack_require__.d(
        actions_namespaceObject,
        ...
        function () {
          return actions_setIsNavigationPanelOpened;
        }
      );
      __webpack_require__.d(
        actions_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        "getEditedPostType",
        function () {
          return selectors_getEditedPostType;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        "getEditedPostId",
        function () {
          return selectors_getEditedPostId;
        }
      );
      __webpack_require__.d(selectors_namespaceObject, "getPage", function () {
        return selectors_getPage;
      });
      __webpack_require__.d(
        selectors_namespaceObject,
        "getNavigationPanelActiveMenu",
        function () {
          return getNavigationPanelActiveMenu;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        ...
        function () {
          return getCurrentTemplateNavigationPanelSubMenu;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        "isNavigationOpened",
        function () {
          return selectors_isNavigationOpened;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        function () {
          return getCurrentTemplateTemplateParts;
        }
      );
      ...
      Object(external_wp_hooks_["addFilter"])(
        ...
        () => external_wp_mediaUtils_["MediaUpload"]
      );
      ...
      const TEMPLATES_TOP_LEVEL = [
        ...TEMPLATES_PRIMARY,
        ...TEMPLATES_SECONDARY,
      ];
      const TEMPLATES_GENERAL = ["page-home"];
      const TEMPLATES_POSTS_PREFIXES = [
        "post-",
        "author-",
        "single-post-",
        "tag-",
      ...
      function navigationPanel() {
        ...
        switch (action.type) {
          ...
          case "OPEN_NAVIGATION_PANEL_TO_MENU":
            return { ...state, isOpen: true, menu: action.menu };
      ...
      function* actions_setTemplate(templateId, templateSlug) {
        ...
        if (!templateSlug) {
          const template = yield external_wp_data_["controls"].resolveSelect(
      ...
      function* addTemplate(template) {
        const newTemplate = yield external_wp_data_["controls"].dispatch(
          external_wp_coreData_["store"],
          "saveEntityRecord",
          "postType",
          "wp_template",
      ...
      function* actions_removeTemplate(template) {
        try {
          ...
          const lastError = yield external_wp_data_["controls"].select(
            external_wp_coreData_["store"],
          ...
          yield external_wp_data_["controls"].dispatch(
            ...
            Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])('"%s" removed.'),
      ...
      function* actions_setPage(page) {
        ...
        if (
          !page.path &&
          (_page$context = page.context) !== null &&
          _page$context !== void 0 &&
          _page$context.postId
        ) {
          const entity = yield external_wp_data_["controls"].resolveSelect(
            external_wp_coreData_["store"],
            "getEntityRecord",
            "postType",
          ...
          page.path = Object(external_wp_url_["getPathAndQueryString"])(
            entity.link
          );
        }
        ...
        yield {
          ...
          page: !templateSlug
            ? page
            : { ...page, context: { ...page.context, templateSlug } },
          templateId,
        };
        return templateId;
      }
      ...
      function* actions_revertTemplate(template) {
        ...
        if (!isTemplateRevertable(template)) {
          yield external_wp_data_["controls"].dispatch(
            external_wp_notices_["store"],
            "createErrorNotice",
            Object(external_wp_i18n_["__"])("This template is not revertable."),
            {
              type: "snackbar",
            }
          );
        ...
        try {
          ...
          const templateEntity = yield external_wp_data_["controls"].select(
            external_wp_coreData_["store"],
            "getEntity",
            "postType",
            template.type
          ...
          const fileTemplatePath = Object(external_wp_url_["addQueryArgs"])(
          ...
          const fileTemplate = yield Object(
            external_wp_dataControls_["apiFetch"]
          )({
          ...
          const serializeBlocks = (_ref) => {
            let { blocks: blocksForSerialization = [] } = _ref;
            return Object(external_wp_blocks_["__unstableSerializeAndClean"])(
              blocksForSerialization
            );
          };

          const edited = yield external_wp_data_["controls"].select(
            external_wp_coreData_["store"],
          ...
          const blocks = Object(external_wp_blocks_["parse"])(
            fileTemplate === null || fileTemplate === void 0
              ? void 0
              : (_fileTemplate$content = fileTemplate.content) === null ||
                _fileTemplate$content === void 0
              ? void 0
              : _fileTemplate$content.raw
          );
          yield external_wp_data_["controls"].dispatch(
            external_wp_coreData_["store"],
            "editEntityRecord",
          ...
          if (allowUndo) {
            const undoRevert = async () => {
              await Object(external_wp_data_["dispatch"])(
                external_wp_coreData_["store"]
            ...
            yield external_wp_data_["controls"].dispatch(
              external_wp_notices_["store"],
              "createSuccessNotice",
              Object(external_wp_i18n_["__"])("Template reverted."),
              {
                type: "snackbar",
                actions: [
                  {
      ...
      function getUnusedTemplates(templates, showOnFront) {
        const templateSlugs = Object(external_lodash_["map"])(
          templates,
          "slug"
        );
      ...
      const getCanUserCreateMedia = Object(
      ...
      const getReusableBlocks = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => () => {
      ...
      const selectors_getSettings = Object(rememo["a" /* default */])(
      ...
      const getCurrentTemplateNavigationPanelSubMenu = Object(
        ...
        if ("wp_template_part" === templateType) {
          ...
          return (
            ((_TEMPLATE_PARTS_SUB_M = TEMPLATE_PARTS_SUB_MENUS.find(
              (submenu) =>
                submenu.area ===
                (template === null || template === void 0
                  ? void 0
                  : template.area)
            )) === null || _TEMPLATE_PARTS_SUB_M === void 0
              ? void 0
              : _TEMPLATE_PARTS_SUB_M.menu) || MENU_TEMPLATE_PARTS
          );
        }
        ...
        const showOnFront = select(
          external_wp_coreData_["store"]
        ).getEditedEntityRecord("root", "site").show_on_front;

        if (
          isTemplateSuperseded(
            template.slug,
            Object(external_lodash_["map"])(templates, "slug"),
            showOnFront
          )
        ) {
      ...
      const getCurrentTemplateTemplateParts = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        ...
        const template = select(
          external_wp_coreData_["store"]
        ).getEditedEntityRecord("postType", templateType, templateId);
        const templateParts = select(
          external_wp_coreData_["store"]
        ).getEntityRecords("postType", "wp_template_part", {
          per_page: -1,
        });
        const templatePartsById = Object(external_lodash_["keyBy"])(
          templateParts,
          (templatePart) => templatePart.id
        );
        return (
          (_template$blocks = template.blocks) !== null &&
          _template$blocks !== void 0
            ? _template$blocks
            : []
        )
          .filter((block) =>
            Object(external_wp_blocks_["isTemplatePart"])(block)
          )
          .map((block) => {
            const {
      ...
      function createBrowserHistory(options) {
        ...
        if (index == null) {
          ...
          globalHistory.replaceState(
            Object(esm_extends["a" /* default */])({}, globalHistory.state, {
              idx: index,
            }),
            ""
          );
      ...
      function createHashHistory(options) {
        ...
        function getIndexAndLocation() {
          var _parsePath = parsePath(window.location.hash.substr(1)),
            ...
            pathname =
              _parsePath$pathname === void 0 ? "/" : _parsePath$pathname,
        ...
        function createHref(to) {
          return (
            getBaseHref() + "#" + (typeof to === "string" ? to : createPath(to))
          );
        }
        ...
        function replace(to, state) {
          ...
          if (allowTx(nextAction, nextLocation, retry)) {
            var _getHistoryStateAndUr4 = getHistoryStateAndUrl(
                nextLocation,
                index
              ),
      ...
      function history_push(params, state) {
        return originalHistoryPush.call(
          history_history,
          Object(external_wp_url_["addQueryArgs"])(
      ...
      function Routes(_ref) {
        let { children } = _ref;
        const [location, setLocation] = Object(
          external_wp_element_["useState"]
        )(() => getLocationWithParams(utils_history.location));
        Object(external_wp_element_["useEffect"])(() => {
          return utils_history.listen((_ref2) => {
            let { location: updatedLocation } = _ref2;
      ...
      const ShortcutList = (_ref) => {
        ...
        return (
          ...
          Object(external_wp_element_["createElement"])(
            ...
            {
              className:
                "edit-site-keyboard-shortcut-help-modal__shortcut-list",
              role: "list",
            },
      ...
      function FeatureToggle(_ref) {
        let { feature, label, info, messageActivated, messageDeactivated } =
          _ref;
      ...
      /* harmony default export */ var tools_more_menu_group =
        ToolsMoreMenuGroup;
      ...
      const download_download = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function SiteExport() {
        const { createErrorNotice } = Object(external_wp_data_["useDispatch"])(
          external_wp_notices_["store"]
        );
      ...
      function MoreMenu() {
        const [isModalActive, toggleModal] = Object(
          external_wp_element_["useReducer"]
        )((isActive) => !isActive, false);
        Object(external_wp_keyboardShortcuts_["useShortcut"])(
          "core/edit-site/keyboard-shortcuts",
          toggleModal
        );
        return Object(external_wp_element_["createElement"])(
          external_wp_element_["Fragment"],
      ...
      function SaveButton(_ref) {
        let { openEntitiesSavedStates, isEntitiesSavedStatesOpen } = _ref;
        const { isDirty, isSaving } = Object(external_wp_data_["useSelect"])(
          (select) => {
            const {
            ...
            return {
              ...
              isSaving: Object(external_lodash_["some"])(
                dirtyEntityRecords,
                (record) =>
      ...
      function getBlockDisplayText(block) {
        if (block) {
          const blockType = Object(external_wp_blocks_["getBlockType"])(
            block.name
          );
          return blockType
            ? Object(external_wp_blocks_["__experimentalGetBlockLabel"])(
                blockType,
                block.attributes
              )
            : null;
      ...
      function useSecondaryText() {
        const { getBlock } = Object(external_wp_data_["useSelect"])(
          external_wp_blockEditor_["store"]
        );
        const activeEntityBlockId = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(
              external_wp_blockEditor_["store"]
      ...
      function DocumentActions(_ref) {
        ...
        const { label } = useSecondaryText(); // The title ref is passed to the popover as the anchorRef so that the
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_i18n_["sprintf"])(
                  ...
                  Object(external_wp_i18n_["__"])("Editing %s: "),
                  entityLabel
                )
              ),
              entityTitle
                    ...
                    return Object(external_wp_element_["createElement"])(
                      external_wp_components_["Button"],
                      {
                        ...
                        label: Object(external_wp_i18n_["sprintf"])(
                          ...
                          Object(external_wp_i18n_["__"])("Show %s details"),
                          entityLabel
                        ),
                      }
                    );
      ...
      function TemplatePartItemMore(_ref) {
        ...
        let { onClose, templatePart, closeTemplateDetailsDropdown } = _ref;
        const { revertTemplate } = Object(external_wp_data_["useDispatch"])(
          store
        );
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["MenuItem"],
              Object(esm_extends["a" /* default */])({}, editLinkProps, {
                onClick: editTemplatePart,
              }),
              Object(external_wp_i18n_["sprintf"])(
                /* translators: %s: template part title */
                Object(external_wp_i18n_["__"])("Edit %s"),
                (_templatePart$title = templatePart.title) === null ||
                  _templatePart$title === void 0
                  ? void 0
                  : _templatePart$title.rendered
              )
            )
          ),
      ...
      function TemplatePartItem(_ref2) {
        let { templatePart, clientId, closeTemplateDetailsDropdown } = _ref2;
        const { selectBlock, toggleBlockHighlight } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_blockEditor_["store"]);
        const templatePartArea = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            external_wp_components_["MenuItem"],
            {
              role: "button",
              icon:
                templatePartArea === null || templatePartArea === void 0
                  ? void 0
                  : templatePartArea.icon,
              iconPosition: "left",
              onClick: () => {
      ...
      function TemplateAreas(_ref4) {
        let { closeTemplateDetailsDropdown } = _ref4;
        const templateParts = Object(external_wp_data_["useSelect"])(
          (select) => select(store).getCurrentTemplateTemplateParts(),
          []
        );
      ...
      function EditTemplateTitle(_ref) {
        ...
        )("postType", template.type, "title", template.id);
        return Object(external_wp_element_["createElement"])(
      ...
      function TemplateDetails(_ref) {
        let { template, onClose } = _ref;
        const { title, description } = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(external_wp_editor_["store"]).__experimentalGetTemplateInfo(
              template
            ),
          []
        );
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(TemplateAreas, {
          ...
          isTemplateRevertable(template) &&
            Object(external_wp_element_["createElement"])(
              ...
              {
                className:
                  "edit-site-template-details__group edit-site-template-details__revert",
              },
              Object(external_wp_element_["createElement"])(
                external_wp_components_["MenuItem"],
                {
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])("Browse all %s"),
      ...
      function Header(_ref) {
        ...
        const {
          ...
          const { getEditedEntityRecord } = select(
            external_wp_coreData_["store"]
          );
            ...
            Object(external_wp_element_["createElement"])(
              ...
              isLargeViewport &&
                Object(external_wp_element_["createElement"])(
                  ...
                  null,
                  Object(external_wp_element_["createElement"])(
                    external_wp_blockEditor_["ToolSelector"],
                    null
                  ),
                  Object(external_wp_element_["createElement"])(
                    UndoButton,
      ...
      const styles_styles = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          viewBox: "0 0 24 24",
          xmlns: "http://www.w3.org/2000/svg",
      ...
      function findInPresetsBy(
        ...
        const orderedPresetsByOrigin = [
          Object(external_lodash_["get"])(features, [
            "blocks",
            blockName,
            ...presetPath,
          ]),
          Object(external_lodash_["get"])(features, presetPath),
        ];
        ...
        for (const presetByOrigin of orderedPresetsByOrigin) {
          if (presetByOrigin) {
            ...
            for (const origin of origins) {
              ...
              if (presets) {
                const presetObject = Object(external_lodash_["find"])(
                  presets,
      ...
      function getPresetVariableFromValue(
        ...
        const metadata = Object(external_lodash_["find"])(PRESET_METADATA, [
          "cssVarInfix",
          cssVarInfix,
        ]);
      ...
      function getValueFromCustomVariable(features, blockName, variable, path) {
        ...
        const result =
          (_get = Object(external_lodash_["get"])(features, [
            "blocks",
            blockName,
            "custom",
            ...path,
            ...
            ? _get
            : Object(external_lodash_["get"])(features, ["custom", ...path]);
      ...
      const useGlobalStylesReset = () => {
        const { user: config, setUserConfig } = Object(
          external_wp_element_["useContext"]
        )(GlobalStylesContext);
        const canReset =
          !!config &&
          !Object(external_lodash_["isEqual"])(config, EMPTY_CONFIG);
        return [
          canReset,
      ...
      function useSetting(path, blockName) {
        ...
        const setSetting = (newValue) => {
          setUserConfig((currentConfig) => {
            const newUserConfig = Object(external_lodash_["cloneDeep"])(
              currentConfig
            );
        ...
        const getSettingValueForContext = (name) => {
          ...
          const getSettingValue = (configToUse) => {
            const result = Object(external_lodash_["get"])(
              configToUse,
              currentPath
            );
              ...
              return (_ref =
                (_result$custom =
                  result === null || result === void 0
                    ? void 0
                    : result.custom) !== null && _result$custom !== void 0
                  ? _result$custom
                  : result === null || result === void 0
                  ? void 0
                  : result.theme) !== null && _ref !== void 0
                ? _ref
                : result === null || result === void 0
                ? void 0
                : result.default;
        ...
        const resultWithFallback =
          (_getSettingValueForCo = getSettingValueForContext(blockName)) !==
            null && _getSettingValueForCo !== void 0
            ? _getSettingValueForCo
            : getSettingValueForContext();
        ...
        switch (source) {
          case "all":
            result = getValueFromVariable(
              mergedConfig.settings,
              blockName,
              (_get = Object(external_lodash_["get"])(
                userConfig,
                finalPath
              )) !== null && _get !== void 0
                ? _get
                : Object(external_lodash_["get"])(baseConfig, finalPath)
            );
            break;
          ...
          case "user":
            result = getValueFromVariable(
              mergedConfig.settings,
              blockName,
              Object(external_lodash_["get"])(userConfig, finalPath)
            );
            break;
      ...
      const hooks_ROOT_BLOCK_SUPPORTS = [
        "background",
        "backgroundColor",
        "color",
        "linkColor",
      ...
      function getSupportedGlobalStylesPanels(name) {
        ...
        const supportKeys = [];
        Object.keys(
          external_wp_blocks_["__EXPERIMENTAL_STYLE_PROPERTY"]
        ).forEach((styleName) => {
          if (
            !external_wp_blocks_["__EXPERIMENTAL_STYLE_PROPERTY"][styleName]
              .support
          ) {
            return;
      ...
      function useColorsPerOrigin(name) {
        ...
        return Object(external_wp_element_["useMemo"])(() => {
          ...
          if (themeColors && themeColors.length) {
            result.push({
              name: Object(external_wp_i18n_["_x"])(
                "Theme",
      ...
      const StylesPreview = () => {
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["Card"],
          {
            ...
            style: {
              background:
                gradientValue !== null && gradientValue !== void 0
                  ? gradientValue
                  : backgroundColor,
            },
          },
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalVStack"],
              {
                spacing: 2,
              },
              Object(external_wp_element_["createElement"])(
                external_wp_components_["ColorIndicator"],
                {
      ...
      function NavigationButton(_ref) {
        let { path, icon, children, isBack = false, ...props } = _ref;
        const navigator = Object(
          external_wp_components_["__experimentalUseNavigator"]
        )();
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__experimentalItem"],
          Object(esm_extends["a" /* default */])(
            {
              onClick: () =>
                navigator.push(path, {
      ...
      const typography = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      const color_color = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          viewBox: "0 0 24 24",
          xmlns: "http://www.w3.org/2000/svg",
      ...
      function BorderPanel(_ref) {
        let { name } = _ref;
        const units = Object(
          external_wp_components_["__experimentalUseCustomUnits"]
        )({
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          (hasBorderWidth || hasBorderStyle) &&
            Object(external_wp_element_["createElement"])(
              ...
              hasBorderWidth &&
                Object(external_wp_element_["createElement"])(
                  external_wp_components_["__experimentalUnitControl"],
                  {
              ...
              hasBorderStyle &&
                Object(external_wp_element_["createElement"])(
                  external_wp_blockEditor_["__experimentalBorderStyleControl"],
                  {
                    value: borderStyle,
          ...
          hasBorderColor &&
            Object(external_wp_element_["createElement"])(
              external_wp_blockEditor_["__experimentalColorGradientControl"],
              {
          ...
          hasBorderRadius &&
            Object(external_wp_element_["createElement"])(
              external_wp_blockEditor_["__experimentalBorderRadiusControl"],
              {
      ...
      function DimensionsPanel(_ref) {
        ...
        const paddingSides = Object(
          external_wp_blockEditor_["__experimentalUseCustomSides"]
        )(name, "padding");
        ...
        const marginSides = Object(
          external_wp_blockEditor_["__experimentalUseCustomSides"]
        )(name, "margin");
        const isAxialMargin =
          marginSides && marginSides.some((side) => AXIAL_SIDES.includes(side));
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__experimentalToolsPanel"],
          {
          ...
          showPaddingControl &&
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalToolsPanelItem"],
              {
      ...
      function TypographyPanel(_ref) {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          supports.includes("fontFamily") &&
            Object(external_wp_element_["createElement"])(
              external_wp_blockEditor_["__experimentalFontFamilyControl"],
              {
          ...
          supports.includes("fontSize") &&
            Object(external_wp_element_["createElement"])(
              external_wp_components_["FontSizePicker"],
              {
                value: fontSize,
          ...
          hasLineHeightEnabled &&
            Object(external_wp_element_["createElement"])(
              external_wp_blockEditor_["LineHeightControl"],
              {
                value: lineHeight,
          ...
          hasAppearanceControl &&
            Object(external_wp_element_["createElement"])(
              external_wp_blockEditor_["__experimentalFontAppearanceControl"],
              {
                value: {
                  fontStyle,
                  fontWeight,
                ...
                onChange: (_ref2) => {
                  let { fontStyle: newFontStyle, fontWeight: newFontWeight } =
                    _ref2;
          ...
          hasLetterSpacingControl &&
            Object(external_wp_element_["createElement"])(
              external_wp_blockEditor_["__experimentalLetterSpacingControl"],
              {
                value: letterSpacing,
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          hasTypographyPanel &&
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_i18n_["__"])("Typography")
            ),
          hasColorPanel &&
            Object(external_wp_element_["createElement"])(
              navigation_button,
              ...
              Object(external_wp_i18n_["__"])("Colors")
            ),
          hasLayoutPanel &&
            Object(external_wp_element_["createElement"])(
              navigation_button,
      ...
      function ScreenRoot() {
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            null,
            Object(external_wp_element_["createElement"])(preview, null)
          ),
          Object(external_wp_element_["createElement"])(
            external_wp_components_["CardBody"],
            null,
            Object(external_wp_element_["createElement"])(context_menu, null)
          ),
          Object(external_wp_element_["createElement"])(
            external_wp_components_["CardDivider"],
            null
          ),
          Object(external_wp_element_["createElement"])(
            external_wp_components_["CardBody"],
      ...
      function ScreenHeader(_ref) {
        let { back, title, description } = _ref;
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__experimentalVStack"],
          {
            spacing: 2,
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalView"],
              null,
              Object(external_wp_element_["createElement"])(navigation_button, {
                path: back,
                icon: Object(external_wp_element_["createElement"])(
                  build_module_icon["a" /* default */],
                  {
                    icon: Object(external_wp_i18n_["isRTL"])()
                      ? chevron_right["a" /* default */]
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalSpacer"],
              null,
              Object(external_wp_element_["createElement"])(
                external_wp_components_["__experimentalHeading"],
                {
      ...
      function ScreenBlockList() {
        return Object(external_wp_element_["createElement"])(
          external_wp_element_["Fragment"],
          null,
          Object(external_wp_element_["createElement"])(global_styles_header, {
            back: "/",
          ...
          Object(external_wp_blocks_["getBlockTypes"])().map((block) =>
            Object(external_wp_element_["createElement"])(BlockMenuItem, {
              block: block,
      ...
      function Item(_ref) {
        let { name, parentMenu, element, label } = _ref;
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_i18n_["__"])("Aa")
            ),
            Object(external_wp_element_["createElement"])(
              external_wp_components_["FlexItem"],
              null,
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_element_["createElement"])(
                  subtitle,
                  null,
                  Object(external_wp_i18n_["__"])("Elements")
                ),
                Object(external_wp_element_["createElement"])(
                  external_wp_components_["__experimentalItemGroup"],
                  {
      ...
      /* harmony default export */ var screen_typography_element =
      ...
      function Palette(_ref) {
        ...
        const colors = Object(external_wp_element_["useMemo"])(
          () => [
        ...
        const paletteButtonText =
          colors.length > 0
            ...
            : Object(external_wp_i18n_["__"])("Add custom colors");
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__experimentalVStack"],
          {
            spacing: 3,
          ...
          Object(external_wp_element_["createElement"])(
            subtitle,
            null,
            Object(external_wp_i18n_["__"])("Palette")
          ),
          Object(external_wp_element_["createElement"])(
            external_wp_components_["__experimentalItemGroup"],
            {
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_element_["createElement"])(
                  ...
                  null,
                  Object(external_wp_element_["createElement"])(
                    external_wp_components_["__experimentalZStack"],
                    {
                      isLayered: false,
                      offset: -8,
                    },
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["FlexItem"],
              null,
              Object(external_wp_i18n_["__"])("Background")
            )
          )
        );
      }
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["FlexItem"],
              null,
              Object(external_wp_i18n_["__"])("Text")
            )
          )
        );
      }
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["FlexItem"],
              null,
              Object(external_wp_i18n_["__"])("Links")
            )
          )
        );
      }
      ...
      function ColorPalettePanel(_ref) {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          !!themeColors &&
            !!themeColors.length &&
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalPaletteEdit"],
              {
          ...
          Object(external_wp_element_["createElement"])(
            external_wp_components_["__experimentalPaletteEdit"],
            {
              ...
              emptyMessage: Object(external_wp_i18n_["__"])(
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              subtitle,
              null,
              Object(external_wp_i18n_["__"])("Duotone")
            ),
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalSpacer"],
              {
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["DuotonePicker"],
              {
      ...
      function ScreenColorPalette(_ref) {
        let { name } = _ref;
        const [currentTab, setCurrentTab] = Object(
          external_wp_element_["useState"]
        )("solid");
        const parentMenu = name === undefined ? "" : "/blocks/" + name;
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            external_wp_components_["__experimentalToggleGroupControl"],
            {
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["__experimentalToggleGroupControlOption"],
              {
                value: "solid",
      ...
      /* harmony default export */ var screen_color_palette =
        ScreenColorPalette;
      ...
      function ScreenBackgroundColor(_ref) {
        ...
        const controlProps = { ...backgroundSettings, ...gradientSettings };
        return Object(external_wp_element_["createElement"])(
          external_wp_element_["Fragment"],
          null,
          Object(external_wp_element_["createElement"])(global_styles_header, {
      ...
      /* harmony default export */ var screen_background_color =
      ...
      function ScreenLayout(_ref) {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          hasDimensionsPanel &&
            Object(external_wp_element_["createElement"])(DimensionsPanel, {
              name: name,
            }),
          hasBorderPanel &&
            Object(external_wp_element_["createElement"])(BorderPanel, {
              name: name,
            })
        );
      }
      ...
      function GlobalStylesUI() {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(screen_root, null)
          ),
          Object(external_wp_element_["createElement"])(
            external_wp_components_["__experimentalNavigatorScreen"],
            {
          ...
          Object(external_wp_element_["createElement"])(ContextScreens, null),
          blocks.map((block) =>
            Object(external_wp_element_["createElement"])(ContextScreens, {
      ...
      function compileStyleValue(uncompiledValue) {
        ...
        if (
          Object(external_lodash_["startsWith"])(
            uncompiledValue,
      ...
      function getPresetsDeclarations() {
        ...
        return Object(external_lodash_["reduce"])(
          PRESET_METADATA,
          (declarations, _ref) => {
            let { path, valueKey, cssVarInfix } = _ref;
            const presetByOrigin = Object(external_lodash_["get"])(
              blockPresets,
              path,
              []
            );
            ["default", "theme", "custom"].forEach((origin) => {
              if (presetByOrigin[origin]) {
                presetByOrigin[origin].forEach((value) => {
                  declarations.push(
                    `--wp--preset--${cssVarInfix}--${Object(
                      external_lodash_["kebabCase"]
                    )(value.slug)}: ${value[valueKey]}`
                  );
                });
              }
            });
      ...
      function getPresetsClasses(blockSelector) {
        ...
        return Object(external_lodash_["reduce"])(
          PRESET_METADATA,
          (declarations, _ref2) => {
            let { path, cssVarInfix, classes } = _ref2;
              ...
              if (presetByOrigin[origin]) {
                presetByOrigin[origin].forEach((_ref3) => {
                  ...
                  classes.forEach((_ref4) => {
                    let { classSuffix, propertyName } = _ref4;
                    const classSelectorToUse = `.has-${Object(
                      external_lodash_["kebabCase"]
                    )(slug)}-${classSuffix}`;
                    const selectorToUse = blockSelector
                      .split(",") // Selector can be "h1, h2, h3"
                      .map((selector) => `${selector}${classSelectorToUse}`)
                      .join(",");
                    const value = `var(--wp--preset--${cssVarInfix}--${Object(
                      external_lodash_["kebabCase"]
                    )(slug)})`;
      ...
      function flattenTree() {
        ...
        Object.keys(input).forEach((key) => {
          const newKey =
            prefix +
            Object(external_lodash_["kebabCase"])(key.replace("/", "-"));
      ...
      function getStylesDeclarations() {
        ...
        return Object(external_lodash_["reduce"])(
          external_wp_blocks_["__EXPERIMENTAL_STYLE_PROPERTY"],
          (declarations, _ref5, key) => {
            let { value, properties } = _ref5;
            ...
            const styleValue = Object(external_lodash_["get"])(
              blockStyles,
              pathToValue
            );
            ...
            if (
              !!properties &&
              !Object(external_lodash_["isString"])(styleValue)
            ) {
              Object.entries(properties).forEach((entry) => {
                const [name, prop] = entry;

                if (
                  !Object(external_lodash_["get"])(styleValue, [prop], false)
                ) {
                ...
                declarations.push(
                  `${cssProperty}: ${compileStyleValue(
                    Object(external_lodash_["get"])(styleValue, [prop])
                  )}`
                );
              });
            } else if (
              Object(external_lodash_["get"])(blockStyles, pathToValue, false)
            ) {
              const cssProperty = key.startsWith("--")
                ? key
                : Object(external_lodash_["kebabCase"])(key);
              declarations.push(
                `${cssProperty}: ${compileStyleValue(
                  Object(external_lodash_["get"])(blockStyles, pathToValue)
                )}`
              );
            }
      ...
      const getNodesWithStyles = (tree, blockSelectors) => {
        ...
        const pickStyleKeys = (treeToPickFrom) =>
          Object(external_lodash_["pickBy"])(treeToPickFrom, (value, key) =>
        ...
        Object(external_lodash_["forEach"])(
          (_tree$styles = tree.styles) === null || _tree$styles === void 0
            ? void 0
            : _tree$styles.elements,
          (value, key) => {
            if (
              !!value &&
              !!external_wp_blocks_["__EXPERIMENTAL_ELEMENTS"][key]
            ) {
              nodes.push({
                styles: value,
        ...
        Object(external_lodash_["forEach"])(
          (_tree$styles2 = tree.styles) === null || _tree$styles2 === void 0
            ? void 0
            : _tree$styles2.blocks,
          (node, blockName) => {
            ...
            if (
              ...
              !!(
                blockSelectors !== null &&
                blockSelectors !== void 0 &&
                (_blockSelectors$block = blockSelectors[blockName]) !== null &&
                _blockSelectors$block !== void 0 &&
                _blockSelectors$block.selector
              )
            ) {
              nodes.push({
                styles: blockStyles,
            ...
            Object(external_lodash_["forEach"])(
              node === null || node === void 0 ? void 0 : node.elements,
              (value, elementName) => {
                if (
                  !!value &&
                  !!(
                  ...
                  !!(
                    external_wp_blocks_["__EXPERIMENTAL_ELEMENTS"] !== null &&
                    external_wp_blocks_["__EXPERIMENTAL_ELEMENTS"] !== void 0 &&
                    external_wp_blocks_["__EXPERIMENTAL_ELEMENTS"][elementName]
                  )
                ) {
                  nodes.push({
                    styles: value,
                    selector: blockSelectors[blockName].selector
                      ...
                      .map(
                        (sel) =>
                          sel +
                          " " +
                          external_wp_blocks_["__EXPERIMENTAL_ELEMENTS"][
                            elementName
                          ]
                      )
                      .join(","),
      ...
      const getNodesWithSettings = (tree, blockSelectors) => {
        ...
        const pickPresets = (treeToPickFrom) => {
          ...
          PRESET_METADATA.forEach((_ref6) => {
            let { path } = _ref6;
            const value = Object(external_lodash_["get"])(
              treeToPickFrom,
              path,
              false
            );
        ...
        const custom =
          (_tree$settings = tree.settings) === null || _tree$settings === void 0
            ? void 0
            : _tree$settings.custom;
        ...
        Object(external_lodash_["forEach"])(
          (_tree$settings2 = tree.settings) === null ||
            _tree$settings2 === void 0
            ? void 0
            : _tree$settings2.blocks,
          (node, blockName) => {
            const blockPresets = pickPresets(node);
            const blockCustom = node.custom;

            if (
              !Object(external_lodash_["isEmpty"])(blockPresets) ||
              !!blockCustom
            ) {
              nodes.push({
      ...
      const toCustomProperties = (tree, blockSelectors) => {
        ...
        settings.forEach((_ref7) => {
          let { presets, custom, selector } = _ref7;
      ...
      const getBlockSelectors = (blockTypes) => {
        ...
        blockTypes.forEach((blockType) => {
          ...
          const selector =
            (_blockType$supports$_ =
              blockType === null || blockType === void 0
                ? void 0
                : (_blockType$supports = blockType.supports) === null ||
                  _blockType$supports === void 0
                ? void 0
                : _blockType$supports.__experimentalSelector) !== null &&
            _blockType$supports$_ !== void 0
              ? _blockType$supports$_
      ...
      function useGlobalStylesOutput() {
        const [stylesheets, setStylesheets] = Object(
          external_wp_element_["useState"]
        )([]);
        const [settings, setSettings] = Object(
          external_wp_element_["useState"]
        )({});
        const { merged: mergedConfig } = Object(
          external_wp_element_["useContext"]
        )(GlobalStylesContext);
        Object(external_wp_element_["useEffect"])(() => {
          if (
          ...
          const blockSelectors = getBlockSelectors(
            Object(external_wp_blocks_["getBlockTypes"])()
          );
      ...
      function GlobalStylesSidebar() {
        ...
        return Object(external_wp_element_["createElement"])(
          DefaultSidebar,
          {
            ...
            icon: library_styles,
            closeLabel: Object(external_wp_i18n_["__"])(
              "Close global styles sidebar"
            ),
            header: Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_element_["createElement"])(
                  "strong",
                  null,
                  Object(external_wp_i18n_["__"])("Styles")
                ),
                Object(external_wp_element_["createElement"])(
                  "span",
                  {
                  ...
                  Object(external_wp_i18n_["__"])("Beta")
                )
              ),
              Object(external_wp_element_["createElement"])(
                external_wp_components_["FlexItem"],
      ...
      const SettingsHeader = (_ref) => {
        ...
        const [templateAriaLabel, templateActiveClass] =
          sidebarName === SIDEBAR_TEMPLATE // translators: ARIA label for the Template sidebar tab, selected.
            ? [
                Object(external_wp_i18n_["__"])("Template (selected)"),
                "is-active",
              ] // translators: ARIA label for the Template Settings Sidebar tab, not selected.
            : [Object(external_wp_i18n_["__"])("Template"), ""];
        const [blockAriaLabel, blockActiveClass] =
          sidebarName === SIDEBAR_BLOCK // translators: ARIA label for the Block Settings Sidebar tab, selected.
      ...
      function template_areas_TemplateAreas() {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_i18n_["__"])("Areas")
          ),
          Object(external_wp_element_["createElement"])(
            "ul",
            {
      ...
      function TemplateCard() {
        const { title, description, icon } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { getEditedPostType, getEditedPostId } = select(store);
      ...
      const { Slot: InspectorSlot, Fill: InspectorFill } = Object(
        external_wp_components_["createSlotFill"]
      )("EditSiteSidebarInspector");
      const SidebarInspectorFill = InspectorFill;
      function SidebarComplementaryAreaFills() {
        const { sidebar, isEditorSidebarOpened, hasBlockSelection } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            sidebarName === SIDEBAR_BLOCK &&
              Object(external_wp_element_["createElement"])(InspectorSlot, {
      ...
      const home = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      const main_dashboard_button_Slot = (_ref) => {
        let { children } = _ref;
        const slot = Object(external_wp_components_["__experimentalUseSlot"])(
          slotName
        );
      ...
      /* harmony default export */ var main_dashboard_button =
        MainDashboardButton;
      ...
      function NavLink(_ref) {
        let { params, replace, ...props } = _ref;
        const linkProps = useLink(params, replace);
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__experimentalNavigationItem"],
          Object(esm_extends["a" /* default */])({}, linkProps, props)
        );
      }

      const NavigationPanel = (_ref2) => {
        let { activeItem = SITE_EDITOR_KEY } = _ref2;
        const { isNavigationOpen, siteTitle } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { getEntityRecord } = select(external_wp_coreData_["store"]);
          const siteData =
        ...
        const { setIsNavigationPanelOpened } = Object(
          external_wp_data_["useDispatch"]
        )(store);
                ...
                Object(external_wp_element_["createElement"])(
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    Object(external_wp_element_["createElement"])(
                      ...
                      {
                        backButtonLabel: Object(external_wp_i18n_["__"])(
                          "Dashboard"
                        ),
                        className:
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    null,
                    Object(external_wp_element_["createElement"])(
                      external_wp_components_["__experimentalNavigationGroup"],
                      {
      ...
      function NavigationToggle(_ref) {
        let { icon } = _ref;
        const { isNavigationOpen, isRequestingSiteIcon, siteIconUrl } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { getEntityRecord, isResolving } = select(
            external_wp_coreData_["store"]
          );
          const siteData =
            getEntityRecord("root", "__unstableBase", undefined) || {};
        ...
        const disableMotion = Object(
          external_wp_compose_["useReducedMotion"]
        )();
      ...
      } = Object(external_wp_components_["createSlotFill"])(
        "EditSiteNavigationPanelPreview"
      );
      const { Fill: NavigationSidebarFill, Slot: NavigationSidebarSlot } =
        Object(external_wp_components_["createSlotFill"])(
          "EditSiteNavigationSidebar"
        );

      function NavigationSidebar(_ref) {
        let { isDefaultOpen = false, activeTemplateType } = _ref;
        const isDesktopViewport = Object(
          external_wp_compose_["useViewportMatch"]
        )("medium");
        const { setIsNavigationPanelOpened } = Object(
          external_wp_data_["useDispatch"]
      ...
      function ConvertToRegularBlocks(_ref) {
        let { clientId } = _ref;
        const { getBlocks } = Object(external_wp_data_["useSelect"])(
          external_wp_blockEditor_["store"]
        );
        const { replaceBlocks } = Object(external_wp_data_["useDispatch"])(
          external_wp_blockEditor_["store"]
        );
        return Object(external_wp_element_["createElement"])(
      ...
      function CreateTemplatePartModal(_ref) {
        let { closeModal, onCreate } = _ref;
        const [title, setTitle] = Object(external_wp_element_["useState"])("");
        const [area, setArea] = Object(external_wp_element_["useState"])(
          TEMPLATE_PART_AREA_GENERAL
        );
        const [isSubmitting, setIsSubmitting] = Object(
          external_wp_element_["useState"]
        )(false);
        const instanceId = Object(external_wp_compose_["useInstanceId"])(
          CreateTemplatePartModal
        );
        const templatePartAreas = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(
              external_wp_editor_["store"]
            ).__experimentalGetDefaultTemplatePartAreas(),
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["BaseControl"],
              {
                label: Object(external_wp_i18n_["__"])("Area"),
                id: `edit-site-create-template-part-modal__area-selection-${instanceId}`,
                className:
                  "edit-site-create-template-part-modal__area-base-control",
              },
              Object(external_wp_element_["createElement"])(
                external_wp_components_["__experimentalRadioGroup"],
                {
                  label: Object(external_wp_i18n_["__"])("Area"),
                  className:
                ...
                templatePartAreas.map((_ref2) => {
                  let { icon, label, area: value, description } = _ref2;
                  return Object(external_wp_element_["createElement"])(
                    external_wp_components_["__experimentalRadio"],
                    {
                      key: label,
                      value: value,
                      className:
                        "edit-site-create-template-part-modal__area-radio",
                    },
                    Object(external_wp_element_["createElement"])(
                      external_wp_components_["Flex"],
                      {
      ...
      function ConvertToTemplatePart(_ref) {
        let { clientIds, blocks } = _ref;
        const [isModalOpen, setIsModalOpen] = Object(
          external_wp_element_["useState"]
        )(false);
        const { replaceBlocks } = Object(external_wp_data_["useDispatch"])(
          external_wp_blockEditor_["store"]
        );
        const { saveEntityRecord } = Object(external_wp_data_["useDispatch"])(
          external_wp_coreData_["store"]
        );
        const { createSuccessNotice } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_notices_["store"]);

        const onConvert = async (_ref2) => {
          let { title, area } = _ref2;
          // Currently template parts only allow latin chars.
          // Fallback slug will receive suffix by default.
          const cleanSlug =
            Object(external_lodash_["kebabCase"])(title).replace(
              /[^\w-]+/g,
              ""
            ) || "wp-custom-part";
          ...
          replaceBlocks(
            clientIds,
            Object(external_wp_blocks_["createBlock"])("core/template-part", {
              slug: templatePart.slug,
              theme: templatePart.theme,
            })
          );
          createSuccessNotice(
            Object(external_wp_i18n_["__"])("Template part created."),
            {
              type: "snackbar",
            }
          ...
          Object(external_wp_element_["createElement"])(
            ...
            () =>
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_i18n_["__"])("Make template part")
              )
          ),
          isModalOpen &&
            Object(external_wp_element_["createElement"])(
      ...
      function TemplatePartConverter() {
        ...
        const { clientIds, blocks } = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        if (
          ...
          ((_blocks$ = blocks[0]) === null || _blocks$ === void 0
            ? void 0
            : _blocks$.name) === "core/template-part"
        ) {
          return Object(external_wp_element_["createElement"])(
      ...
      function NavigateToLink(_ref) {
        let { type, id, activePage, onActivePageChange } = _ref;
        const post = Object(external_wp_data_["useSelect"])(
          (select) =>
            type &&
            id &&
            type !== "URL" &&
        ...
        const onClick = Object(external_wp_element_["useMemo"])(() => {
          ...
          const path = Object(external_wp_url_["getPathAndQueryString"])(
            post.link
          );
          if (
            path ===
      ...
      function BlockInspectorButton(_ref) {
        let { onClick = () => {} } = _ref;
        const { shortcut, isBlockInspectorOpen } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => ({
            shortcut: select(
      ...
      function EditTemplatePartMenuButton() {
        return Object(external_wp_element_["createElement"])(
          ...
          null,
          (_ref) => {
            let { selectedClientIds, onClose } = _ref;
            return Object(external_wp_element_["createElement"])(
      ...
      function EditTemplatePartMenuItem(_ref2) {
        let { selectedClientId, onClose } = _ref2;
        const { params } = useLocation();
        const selectedTemplatePart = Object(external_wp_data_["useSelect"])(
          (select) => {
            const block = select(external_wp_blockEditor_["store"]).getBlock(
              selectedClientId
            );

            if (block && Object(external_wp_blocks_["isTemplatePart"])(block)) {
              const { theme, slug } = block.attributes;
              return select(external_wp_coreData_["store"]).getEntityRecord(
                "postType",
                "wp_template_part", // Ideally this should be an official public API.
                `${theme}//${slug}`
              );
            }
          },
        ...
        const linkProps = useLink(
          {
            postId:
              selectedTemplatePart === null || selectedTemplatePart === void 0
                ? void 0
                : selectedTemplatePart.id,
            postType:
              selectedTemplatePart === null || selectedTemplatePart === void 0
                ? void 0
                : selectedTemplatePart.type,
          },
          {
            fromTemplateId: params.postId,
          }
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["MenuItem"],
          Object(esm_extends["a" /* default */])({}, linkProps, {
            onClick: (event) => {
      ...
      function BackButton() {
        ...
        const previousTemplateId =
          ...
          _location$state === void 0
            ? void 0
            : _location$state.fromTemplateId;
      ...
      function ResizeHandle(_ref) {
        let { direction, resizeWidthBy } = _ref;
        ...
        function handleKeyDown(event) {
          ...
          if (
            (direction === "left" &&
              keyCode === external_wp_keycodes_["LEFT"]) ||
            (direction === "right" &&
              keyCode === external_wp_keycodes_["RIGHT"])
          ) {
            resizeWidthBy(DELTA_DISTANCE);
          } else if (
            (direction === "left" &&
              keyCode === external_wp_keycodes_["RIGHT"]) ||
            (direction === "right" && keyCode === external_wp_keycodes_["LEFT"])
          ) {
            resizeWidthBy(-DELTA_DISTANCE);
          }
        }
      ...
      function ResizableEditor(_ref) {
        let { enableResizing, settings, ...props } = _ref;
        const deviceType = Object(external_wp_data_["useSelect"])(
          (select) => select(store).__experimentalGetPreviewDeviceType(),
          []
        );
        const deviceStyles = Object(
          external_wp_blockEditor_["__experimentalUseResizeCanvas"]
        )(deviceType);
        const [width, setWidth] = Object(external_wp_element_["useState"])(
          DEFAULT_STYLES.width
        );
        const [height, setHeight] = Object(external_wp_element_["useState"])(
          DEFAULT_STYLES.height
        );
        const iframeRef = Object(external_wp_element_["useRef"])();
        const mouseMoveTypingResetRef = Object(
          external_wp_blockEditor_["__unstableUseMouseMoveTypingReset"]
        )();
        const ref = Object(external_wp_compose_["useMergeRefs"])([
          iframeRef,
          mouseMoveTypingResetRef,
        ]);
        Object(external_wp_element_["useEffect"])(
          function autoResizeIframeHeight() {
            ...
            return () => {
              ...
              _iframe$contentWindow === void 0
                ? void 0
                : _iframe$contentWindow.cancelAnimationFrame(animationFrame);
              (_resizeObserver2 = resizeObserver) === null ||
              _resizeObserver2 === void 0
                ? void 0
        ...
        const resizeWidthBy = Object(external_wp_element_["useCallback"])(
          (deltaPixels) => {
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["ResizableBox"],
          {
            size: {
              width,
              height,
            ...
            resizeRatio: 2,
            handleComponent: {
              left: Object(external_wp_element_["createElement"])(
                ResizeHandle,
                {
                  direction: "left",
              ...
              right: Object(external_wp_element_["createElement"])(
                ResizeHandle,
                {
                  direction: "right",
                  resizeWidthBy: resizeWidthBy,
            ...
            Object(esm_extends["a" /* default */])(
              {
                ...
                head: Object(external_wp_element_["createElement"])(
                  ...
                  Object(external_wp_element_["createElement"])(
                    "style",
                    null, // Forming a "block formatting context" to prevent margin collapsing.
                  ...
                  enableResizing &&
                    Object(external_wp_element_["createElement"])(
                      "style",
                      null, // Force the <html> and <body>'s heights to fit the content.
      ...
      function BlockEditor(_ref) {
        let { setIsInserterOpen } = _ref;
        const { settings, templateType, templateId, page } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => {
        ...
        const { setPage } = Object(external_wp_data_["useDispatch"])(store);
        const contentRef = Object(external_wp_element_["useRef"])();
        const mergedRefs = Object(external_wp_compose_["useMergeRefs"])([
          contentRef,
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            external_wp_blockEditor_["__experimentalLinkControl"].ViewerFill,
            null,
            Object(external_wp_element_["useCallback"])(
              (fillProps) =>
                Object(external_wp_element_["createElement"])(
                  NavigateToLink,
                  Object(esm_extends["a" /* default */])({}, fillProps, {
                    activePage: page,
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(back_button, null),
            Object(external_wp_element_["createElement"])(
              resizable_editor, // Reinitialize the editor and reset the states when the template changes.
              {
                key: templateId,
                enableResizing:
                  isTemplatePart && // Disable resizing in mobile viewport.
                  !isMobileViewport,
                settings: settings,
      ...
      function KeyboardShortcuts(_ref) {
        let { openEntitiesSavedStates } = _ref;
        const { __experimentalGetDirtyEntityRecords, isSavingEntityRecord } =
          Object(external_wp_data_["useSelect"])(
            external_wp_coreData_["store"]
          );
        const isListViewOpen = Object(external_wp_data_["useSelect"])(
          (select) => select(store).isListViewOpened(),
          []
        );
        const isBlockInspectorOpen = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(build_module["i" /* store */]).getActiveComplementaryArea(
              store.name
            ) === SIDEBAR_BLOCK,
        ...
        const { setIsListViewOpened } = Object(
          external_wp_data_["useDispatch"]
        )(store);
        const { enableComplementaryArea, disableComplementaryArea } = Object(
          external_wp_data_["useDispatch"]
      ...
      function URLQueryController() {
        const { setTemplate, setTemplatePart, setPage } = Object(
          external_wp_data_["useDispatch"]
        )(store);
        const {
      ...
      function InserterSidebar() {
        ...
        const isMobile = Object(external_wp_compose_["useViewportMatch"])(
          "medium",
          "<"
        );
      ...
      function ListViewSidebar() {
        ...
        const { clearSelectedBlock, selectBlock } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_blockEditor_["store"]);
      ...
      function ErrorBoundaryWarning(_ref2) {
        let { message, error, reboot, dashboardLink } = _ref2;
        const actions = [];
      ...
      class error_boundary_ErrorBoundary extends external_wp_element_[
        "Component"
      ] {
        constructor() {
          super(...arguments);
      ...
      function WelcomeGuideEditor() {
        ...
        const isActive = Object(external_wp_data_["useSelect"])(
          (select) => select(store).isFeatureActive("welcomeGuide"),
          []
        );
            ...
            pages: [
              {
                image: Object(external_wp_element_["createElement"])(
                  ...
                  {
                    nonAnimatedSrc:
                      "https://s.w.org/images/block-editor/edit-your-site.svg?1",
                    animatedSrc:
                      "https://s.w.org/images/block-editor/edit-your-site.gif?1",
                  }
                ),
                content: Object(external_wp_element_["createElement"])(
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    Object(external_wp_i18n_["__"])("Edit your site")
                  ),
                  Object(external_wp_element_["createElement"])(
                    "p",
                    {
      ...
      function WelcomeGuideStyles() {
        ...
        const { isActive, isStylesOpen } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
            ...
            pages: [
              {
                image: Object(external_wp_element_["createElement"])(
                  ...
                  {
                    nonAnimatedSrc:
                      "https://s.w.org/images/block-editor/welcome-to-styles.svg?1",
                    animatedSrc:
                      "https://s.w.org/images/block-editor/welcome-to-styles.gif?1",
                  }
                ),
                content: Object(external_wp_element_["createElement"])(
                  external_wp_element_["Fragment"],
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    Object(external_wp_i18n_["__"])("Welcome to Styles")
                  ),
                  Object(external_wp_element_["createElement"])(
                    "p",
                    {
              ...
              },
              {
                image: Object(external_wp_element_["createElement"])(
                  ...
                  {
                    nonAnimatedSrc:
                      "https://s.w.org/images/block-editor/set-the-design.svg?1",
                    animatedSrc:
                      "https://s.w.org/images/block-editor/set-the-design.gif?1",
                  }
                ),
                content: Object(external_wp_element_["createElement"])(
                  external_wp_element_["Fragment"],
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    Object(external_wp_i18n_["__"])("Set the design")
                  ),
                  Object(external_wp_element_["createElement"])(
                    "p",
                    {
              ...
              },
              {
                image: Object(external_wp_element_["createElement"])(
                  ...
                  {
                    nonAnimatedSrc:
                      "https://s.w.org/images/block-editor/personalize-blocks.svg?1",
                    animatedSrc:
                      "https://s.w.org/images/block-editor/personalize-blocks.gif?1",
                  }
                ),
                content: Object(external_wp_element_["createElement"])(
                  external_wp_element_["Fragment"],
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    Object(external_wp_i18n_["__"])("Personalize blocks")
                  ),
                  Object(external_wp_element_["createElement"])(
                    "p",
                    {
              ...
              },
              {
                ...
                content: Object(external_wp_element_["createElement"])(
                  ...
                  Object(external_wp_element_["createElement"])(
                    ...
                    Object(external_wp_i18n_["__"])("Learn more")
                  ),
                  Object(external_wp_element_["createElement"])(
                    "p",
                    {
      ...
      function useGlobalStylesRenderer() {
        ...
        const { getSettings } = Object(external_wp_data_["useSelect"])(store);
        const { updateSettings } = Object(external_wp_data_["useDispatch"])(
          store
        );
        Object(external_wp_element_["useEffect"])(() => {
          if (!styles || !settings) {
          ...
          const nonGlobalStyles = Object(external_lodash_["filter"])(
      ...
      function mergeBaseAndUserConfigs(base, user) {
        return Object(external_lodash_["mergeWith"])(
          {},
          base,
          user,
      ...
      const cleanEmptyObject = (object) => {
        if (
          !Object(external_lodash_["isObject"])(object) ||
          Array.isArray(object)
        ) {
          return object;
        }

        const cleanedNestedObjects = Object(external_lodash_["pickBy"])(
          Object(external_lodash_["mapValues"])(object, cleanEmptyObject),
          external_lodash_["identity"]
        );
        return Object(external_lodash_["isEmpty"])(cleanedNestedObjects)
          ? undefined
          : cleanedNestedObjects;
      };

      function useGlobalStylesUserConfig() {
        const { globalStylesId, settings, styles } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          ...
          const record = _globalStylesId
            ? select(external_wp_coreData_["store"]).getEditedEntityRecord(
                "root",
                "globalStyles",
                _globalStylesId
              )
          ...
          return {
            ...
            settings:
              record === null || record === void 0 ? void 0 : record.settings,
            styles:
              record === null || record === void 0 ? void 0 : record.styles,
          };
        }, []);
        const { getEditedEntityRecord } = Object(
          external_wp_data_["useSelect"]
        )(external_wp_coreData_["store"]);
        ...
        const setConfig = Object(external_wp_element_["useCallback"])(
          (callback) => {
              ...
              styles:
                (_record$styles =
                  record === null || record === void 0
                    ? void 0
                    : record.styles) !== null && _record$styles !== void 0
                  ? _record$styles
                  : {},
              settings:
                (_record$settings =
                  record === null || record === void 0
                    ? void 0
                    : record.settings) !== null && _record$settings !== void 0
                  ? _record$settings
                  : {},
            };
      ...
      function useTitle(title) {
        ...
        const siteTitle = Object(external_wp_data_["useSelect"])((select) => {
          ...
          return (_select$getEntityReco = select(
            external_wp_coreData_["store"]
          ).getEntityRecord("root", "site")) === null ||
            _select$getEntityReco === void 0
            ? void 0
            : _select$getEntityReco.title;
        }, []);
        const isInitialLocationRef = Object(external_wp_element_["useRef"])(
          true
        );
        Object(external_wp_element_["useEffect"])(() => {
        ...
        Object(external_wp_element_["useEffect"])(() => {
          ...
          if (title && siteTitle) {
            // @see https://github.com/WordPress/wordpress-develop/blob/94849898192d271d533e09756007e176feb80697/src/4dm1n/admin-header.php#L67-L68
            const formattedTitle = Object(external_wp_i18n_["sprintf"])(
              /* translators: Admin screen title. 1: Admin screen name, 2: Network or site name. */
              Object(external_wp_i18n_["__"])("%1$s ‹ %2$s — WordPress"),
              title,
              siteTitle
            );
            ...
            Object(external_wp_a11y_["speak"])(
              Object(external_wp_i18n_["sprintf"])(
                ...
                Object(external_wp_i18n_["__"])("Now displaying: %s"),
                document.title
              ),
              "assertive"
            );
      ...
      function Editor(_ref) {
        ...
        const {
          ...
          const { hasFinishedResolution, getEntityRecord } = select(
            external_wp_coreData_["store"]
          );
          const postType = getEditedPostType();
        ...
        const { setPage, setIsInserterOpened } = Object(
          external_wp_data_["useDispatch"]
        )(store);
        const { enableComplementaryArea } = Object(
          external_wp_data_["useDispatch"]
        ...
        const openEntitiesSavedStates = Object(
          external_wp_element_["useCallback"]
        )(() => setIsEntitiesSavedStatesOpen(true), []);
        const closeEntitiesSavedStates = Object(
          external_wp_element_["useCallback"]
        )(() => {
          setIsEntitiesSavedStatesOpen(false);
        }, []);
        const blockContext = Object(external_wp_element_["useMemo"])(
          () => ({
                      ...
                      Object(external_wp_element_["createElement"])(
                        ...
                        Object(external_wp_element_["createElement"])(
                          build_module["e" /* InterfaceSkeleton */],
                          {
                            ...
                            notices: Object(
                              external_wp_element_["createElement"]
                            )(external_wp_editor_["EditorSnackbars"], null),
                            content: Object(
                              external_wp_element_["createElement"]
                            )(
                              external_wp_element_["Fragment"],
      ...
      function NewTemplate(_ref) {
        let { postType } = _ref;
        const history = useHistory();
        const { templates, defaultTemplateTypes } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => ({
            templates: select(external_wp_coreData_["store"]).getEntityRecords(
              "postType",
              "wp_template",
              {
                per_page: -1,
        ...
        const { getLastEntitySaveError } = Object(
          external_wp_data_["useSelect"]
        )(external_wp_coreData_["store"]);
        ...
        async function createTemplate(_ref2) {
          ...
          try {
            const { title, description } = Object(external_lodash_["find"])(
        ...
        const existingTemplateSlugs = Object(external_lodash_["map"])(
          templates,
          "slug"
        );
        const missingTemplates = Object(external_lodash_["filter"])(
          defaultTemplateTypes,
          (template) =>
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          () =>
            Object(external_wp_element_["createElement"])(
              external_wp_components_["NavigableMenu"],
              {
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_lodash_["map"])(missingTemplates, (_ref3) => {
                  let { title, description, slug } = _ref3;
                  return Object(external_wp_element_["createElement"])(
                    external_wp_components_["MenuItem"],
                    {
                      info: description,
      ...
      function NewTemplatePart(_ref) {
        ...
        async function createTemplatePart(_ref2) {
          ...
          if (!title) {
            createErrorNotice(
              Object(external_wp_i18n_["__"])("Title is not defined."),
              {
                type: "snackbar",
              }
            );
      ...
      function AddNewTemplate(_ref) {
        let { templateType = "wp_template" } = _ref;
        const postType = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(external_wp_coreData_["store"]).getPostType(templateType),
          [templateType]
        );
      ...
      function RenameMenuItem(_ref) {
        ...
        const { editEntityRecord, saveEditedEntityRecord } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_coreData_["store"]);
        const { createSuccessNotice, createErrorNotice } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_notices_["store"]);
        ...
        async function onTemplateRename(event) {
          ...
          try {
            ...
            createSuccessNotice(
              Object(external_wp_i18n_["__"])("Template has been renamed."),
              {
                type: "snackbar",
              }
            );
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_i18n_["__"])("Rename")
          ),
          isModalOpen &&
            Object(external_wp_element_["createElement"])(
              external_wp_components_["Modal"],
      ...
      function Actions(_ref) {
        let { template } = _ref;
        const { removeTemplate, revertTemplate } = Object(
          external_wp_data_["useDispatch"]
        )(store);
        const { saveEditedEntityRecord } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_coreData_["store"]);
        const { createSuccessNotice, createErrorNotice } = Object(
          external_wp_data_["useDispatch"]
      ...
      const commentAuthorAvatar = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      /* harmony default export */ var comment_author_avatar =
        commentAuthorAvatar;
      ...
      function CustomizedTooltip(_ref) {
        let { isCustomized, children } = _ref;
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["Tooltip"],
          {
            text: Object(external_wp_i18n_["__"])(
      ...
      function BaseAddedBy(_ref2) {
        let { text, icon, imageUrl, isCustomized } = _ref2;
        const [isImageLoaded, setIsImageLoaded] = Object(
          external_wp_element_["useState"]
        )(false);
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__experimentalHStack"],
      ...
      function AddedByTheme(_ref3) {
        ...
        let { slug, isCustomized } = _ref3;
        const theme = Object(external_wp_data_["useSelect"])(
          (select) => select(external_wp_coreData_["store"]).getTheme(slug),
          [slug]
        );
        return Object(external_wp_element_["createElement"])(BaseAddedBy, {
          ...
          text:
            (theme === null || theme === void 0
              ? void 0
              : (_theme$name = theme.name) === null || _theme$name === void 0
              ? void 0
              : _theme$name.rendered) || slug,
          isCustomized: isCustomized,
        });
      }

      function AddedByPlugin(_ref4) {
        let { slug, isCustomized } = _ref4;
        const plugin = Object(external_wp_data_["useSelect"])(
          (select) => select(external_wp_coreData_["store"]).getPlugin(slug),
          [slug]
        );
        return Object(external_wp_element_["createElement"])(BaseAddedBy, {
          icon: plugins["a" /* default */],
          text:
            (plugin === null || plugin === void 0 ? void 0 : plugin.name) ||
            slug,
          isCustomized: isCustomized,
        });
      }
      ...
      function AddedByAuthor(_ref5) {
        ...
        let { id } = _ref5;
        const user = Object(external_wp_data_["useSelect"])(
          (select) => select(external_wp_coreData_["store"]).getUser(id),
          [id]
        );
        return Object(external_wp_element_["createElement"])(BaseAddedBy, {
          ...
          imageUrl:
            user === null || user === void 0
              ? void 0
              : (_user$avatar_urls = user.avatar_urls) === null ||
                _user$avatar_urls === void 0
              ? void 0
              : _user$avatar_urls[48],
          text: user === null || user === void 0 ? void 0 : user.nickname,
        });
      }

      function AddedBySite() {
        const { name, logoURL } = Object(external_wp_data_["useSelect"])(
          (select) => {
            var _getMedia;

            const { getEntityRecord, getMedia } = select(
              external_wp_coreData_["store"]
            );
            const siteData = getEntityRecord("root", "__unstableBase");
            return {
              name:
                siteData === null || siteData === void 0
                  ? void 0
                  : siteData.name,
              logoURL:
                siteData !== null && siteData !== void 0 && siteData.site_logo
                  ? (_getMedia = getMedia(siteData.site_logo)) === null ||
                    _getMedia === void 0
                    ? void 0
                    : _getMedia.source_url
                  : undefined,
            };
          },
          []
      ...
      function AddedBy(_ref6) {
        let { templateType, template } = _ref6;
      ...
      function Table(_ref) {
        let { templateType } = _ref;
        const { templates, isLoading, postType } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => {
        ...
        if (!templates.length) {
          ...
          return Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])("No %s found."),
              postType === null || postType === void 0
                ? void 0
                : (_postType$labels = postType.labels) === null ||
                  _postType$labels === void 0
                ? void 0
                : (_postType$labels$name = _postType$labels.name) === null ||
                  _postType$labels$name === void 0
                ? void 0
                : _postType$labels$name.toLowerCase()
            )
          );
        }
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_element_["createElement"])(
                  ...
                  Object(external_wp_i18n_["__"])("Added by")
                ),
                Object(external_wp_element_["createElement"])(
                  "th",
                  {
                  ...
                  Object(external_wp_element_["createElement"])(
                    external_wp_components_["VisuallyHidden"],
                    null,
                    Object(external_wp_i18n_["__"])("Actions")
                  )
                )
              )
            ),
                    ...
                    Object(external_wp_element_["createElement"])(
                      ...
                      Object(external_wp_element_["createElement"])(
                        ...
                        Object(external_wp_htmlEntities_["decodeEntities"])(
                          ((_template$title = template.title) === null ||
                          _template$title === void 0
                            ? void 0
                            : _template$title.rendered) || template.slug
                        )
                      )
                    ),
      ...
      function List() {
        ...
        const { previousShortcut, nextShortcut, isNavigationOpen } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          return {
            previousShortcut: select(
        ...
        const itemsListLabel =
          postType === null || postType === void 0
            ? void 0
            : (_postType$labels2 = postType.labels) === null ||
              _postType$labels2 === void 0
            ? void 0
            : _postType$labels2.items_list;
        const detailedRegionLabels = postType
          ? {
              header: Object(external_wp_i18n_["sprintf"])(
                // translators: %s - the name of the page, 'Header' as in the header area of that page.
                Object(external_wp_i18n_["__"])("%s - Header"),
                itemsListLabel
              ),
              body: Object(external_wp_i18n_["sprintf"])(
                // translators: %s - the name of the page, 'Content' as in the content area of that page.
                Object(external_wp_i18n_["__"])("%s - Content"),
                itemsListLabel
              ),
            }
          : undefined;
        return Object(external_wp_element_["createElement"])(
          build_module["e" /* InterfaceSkeleton */],
          {
            ...
            drawer: Object(external_wp_element_["createElement"])(
              navigation_sidebar.Slot,
              null
            ),
          ...
          Object(external_wp_element_["createElement"])(
            ...
            (_ref2) => {
              ...
              return Object(external_wp_element_["createElement"])(
                ...
                null,
                isListPage
                  ? Object(external_wp_element_["createElement"])(List, null)
                  : Object(external_wp_element_["createElement"])(editor, {
                      onError: reboot,
                    }),
                Object(external_wp_element_["createElement"])(
                  navigation_sidebar, // Open the navigation sidebar by default when in the list page.
                  {
                    isDefaultOpen: !!isListPage,
                    activeTemplateType: isListPage
                      ? params.postType
                      : undefined,
                  }
                )
      ...
      async function getHomepageParams(siteUrl) {
        ...
        const template = await window
          .fetch(
            Object(external_wp_url_["addQueryArgs"])(siteUrl, {
      ...
      /* harmony default export */ var plugin_more_menu_item = Object(
        ...
        Object(external_wp_plugins_["withPluginContext"])(
          (context, ownProps) => {
            return {
      ...
      async function reinitializeEditor(target, settings) {
...

        {
          ...
          const isLandingOnListPage = getIsListPage(
            Object(external_wp_url_["getQueryArgs"])(window.location.href)
          );
          ...
          if (isLandingOnListPage) {
            ...
            Object(external_wp_data_["dispatch"])(
              ...
              Object(external_wp_data_["select"])(
                external_wp_viewport_["store"]
              ).isViewportMatch("medium")
            );
          }
        }
        Object(external_wp_element_["render"])(
          Object(external_wp_element_["createElement"])(EditSiteApp, {
            reboot: reboot,
          }),
          target
        );
      ...
      function initializeEditor(id, settings) {
        ...
        settings.__experimentalFetchRichUrlData =
          external_wp_coreData_["__experimentalFetchUrlData"];
...
*/
    ...
    /***/ U60i: /***/ function (
      ...
      const preferences = Object(external_wp_data_["combineReducers"])({
        features() {
          ...
          if (action.type === "SET_FEATURE_VALUE") {
            ...
            return {
              ...state,
              [scope]: { ...state[scope], [featureName]: value },
            };
          }
      ...
      function isFeatureActive(state, scope, featureName) {
        ...
        const featureValue =
          (_state$preferences$fe = state.preferences.features[scope]) ===
            null || _state$preferences$fe === void 0
            ? void 0
            : _state$preferences$fe[featureName];
        const defaultedFeatureValue =
          featureValue !== undefined
            ? featureValue
            : (_state$preferenceDefa =
                state.preferenceDefaults.features[scope]) === null ||
          ...
          DropdownComponent,
          {
            ...
            popoverProps: {
              ...
              className: classnames_default()(
                ...
                popoverProps === null || popoverProps === void 0
                  ? void 0
    ...
    /***/ iClF: /***/ function (
      ...
      function Icon(_ref) {
        ...
        return Object(
          _wordpress_element__WEBPACK_IMPORTED_MODULE_0__["cloneElement"]
        )(icon, {
          width: size,
          height: size,
          ...props,
    ...
    /***/ rrFr: /***/ function (module, exports, __webpack_require__) {
      var __WEBPACK_AMD_DEFINE_FACTORY__,
        __WEBPACK_AMD_DEFINE_ARRAY__,
        __WEBPACK_AMD_DEFINE_RESULT__; //download.js v4.2, by dandavis; 2008-2016. [MIT] see http://danml.com/download.html for tests/usage
