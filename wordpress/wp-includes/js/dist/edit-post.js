  ...
  /******/ {
    ...
    /***/ T40v: /***/ function (
        ...
        panels(state, action) {
          switch (action.type) {
            ...
            case "TOGGLE_PANEL_OPENED": {
              ...
              return {
                ...state,
                [panelName]: { ...state[panelName], opened: !isOpen },
              };
            }
          }
        ...
        hiddenBlockTypes(state, action) {
          switch (action.type) {
            case "SHOW_BLOCK_TYPES":
              return Object(external_lodash_["without"])(
                state,
                ...action.blockNames
              );
      ...
      function* requestMetaBoxUpdates() {
        ...
        const activeMetaBoxLocations = yield external_wp_data_[
          "controls"
        ].select(store, "getActiveMetaBoxLocations");
      ...
      function* initializeMetaBoxes() {
        ...
        const hasMetaBoxes = yield external_wp_data_["controls"].select(
          store,
          "hasMetaBoxes"
        ...
        Object(external_wp_data_["subscribe"])(() => {
          ...
          //
          // See: https://github.com/WordPress/WordPress/blob/5.1.1/4dm1n/includes/post.php#L2307-L2309
      ...
      const isEditorSidebarOpened = Object(
      ...
      const isPluginSidebarOpened = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => () => {
        const activeGeneralSidebar = select(
          build_module["i" /* store */]
      ...
      const getActiveGeneralSidebarName = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => () => {
      ...
      const isPluginItemPinned = Object(
        external_wp_data_["createRegistrySelector"]
      ...
      const getEditedPostTemplate = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => () => {
        const currentTemplate = select(
          external_wp_editor_["store"]
        ...
        if (currentTemplate) {
          ...
          const templateWithSameSlug =
            (_select$getEntityReco = select(
              external_wp_coreData_["store"]
            ).getEntityRecords("postType", "wp_template", {
              per_page: -1,
            })) === null || _select$getEntityReco === void 0
              ? void 0
              : _select$getEntityReco.find(
        ...
        if (post.link) {
          return select(
            external_wp_coreData_["store"]
          ).__experimentalGetTemplateForLink(post.link);
        }
...
*/
    ...
    /***/ Y5n4: /***/ function (
      ...
      function CustomFieldsConfirmation(_ref) {
        let { willEnable } = _ref;
        const [isReloading, setIsReloading] = Object(
      ...
      function EnableCustomFieldsOption(_ref2) {
        ...
        const [isChecked, setIsChecked] = Object(
          external_wp_element_["useState"]
      ...
      /* harmony default export */ var enable_panel = Object(
        ...
        Object(external_wp_data_["withDispatch"])((dispatch, _ref3) => {
          ...
          return {
            onChange: () =>
              dispatch(store["a" /* store */]).toggleEditorPanelEnabled(
                panelName
              ),
          };
        })
      ...
      /* harmony default export */ var enable_feature = Object(
        ...
        Object(external_wp_data_["withDispatch"])((dispatch, _ref2) => {
          ...
          return {
            onChange: () =>
              dispatch(store["a" /* store */]).toggleFeature(featureName),
          };
        })
      )(base);
    ...
    /***/ dSQ2: /***/ function (
      ...
      const enhance = Object(external_wp_compose_["compose"])(
        ...
        Object(external_wp_data_["withSelect"])((select, block) => {
          ...
          const firstOfSameType = Object(external_lodash_["find"])(
            blocks,
            (_ref) => {
              let { name } = _ref;
        ...
        Object(external_wp_data_["withDispatch"])((dispatch, _ref2) => {
          ...
          return {
            selectFirst: () =>
              dispatch(external_wp_blockEditor_["store"]).selectBlock(
                originalBlockClientId
              ),
          };
        })
      );
      const withMultipleValidation = Object(
      ...
      function CopyContentMenuItem() {
        ...
        const getText = Object(external_wp_data_["useSelect"])(
          (select) => () =>
            select(external_wp_editor_["store"]).getEditedPostAttribute(
              "content"
            ),
          []
        );
        ...
        const ref = Object(external_wp_compose_["useCopyToClipboard"])(
          getText,
          onSuccess
        );
        return Object(external_wp_element_["createElement"])(
      ...
      /* harmony default export */ var keyboard_shortcuts_help_menu_item =
        Object(external_wp_data_["withDispatch"])((dispatch) => {
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                external_wp_components_["Button"],
                {
                  ...
                  onClick: onExit,
                  shortcut:
                    external_wp_keycodes_["displayShortcut"].secondary("m"),
                },
      ...
      function BlockInspectorButton(_ref) {
        ...
        const { shortcut, areAdvancedSettingsOpened } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => ({
            shortcut: select(
      ...
      function VisualEditor(_ref2) {
        ...
        const themeSupportsLayout = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        const { setIsEditingTemplate } = Object(
          external_wp_data_["useDispatch"]
        )(store["a" /* store */]);
        ...
        const defaultLayout = Object(external_wp_blockEditor_["useSetting"])(
          "layout"
        );
        ...
        const contentRef = Object(external_wp_compose_["useMergeRefs"])([
          ...
          Object(
            external_wp_blockEditor_["__unstableUseCanvasClickRedirect"]
          )(),
      ...
      function MetaBoxesSection(_ref) {
        ...
        const thirdPartyMetaBoxes = Object(external_lodash_["filter"])(
          metaBoxes,
          (_ref2) => {
            let { id } = _ref2;
      ...
      function BlockManagerCategory(_ref) {
        ...
        const settings = Object(external_wp_element_["useContext"])(
          edit_post_settings
        );
        const { allowedBlockTypes } = settings;
        const filteredBlockTypes = Object(
          external_wp_element_["useMemo"]
        )(() => {
      ...
      /* harmony default export */ var block_manager_category = Object(
        ...
        Object(external_wp_data_["withDispatch"])((dispatch, ownProps) => {
          const { showBlockTypes, hideBlockTypes } = dispatch(
            store["a" /* store */]
          );
          return {
            ...
            toggleAllVisible(nextIsChecked) {
              const blockNames = Object(external_lodash_["map"])(
                ownProps.blockTypes,
                "name"
              );
      ...
      /* harmony default export */ var block_manager = Object(
        external_wp_data_["withSelect"]
      )((select) => {
        const {
          getBlockTypes,
      ...
      function PreferencesModal() {
        ...
        const { isModalActive, isViewable } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
        ...
        const showBlockBreadcrumbsOption = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => {
            const { getEditorSettings } = select(external_wp_editor_["store"]);
            const { getEditorMode, isFeatureActive } = select(
              store["a" /* store */]
            );
        ...
        const [activeMenu, setActiveMenu] = Object(
          external_wp_element_["useState"]
        )(PREFERENCES_MENU);
        /**
        ...
        const { tabs, sectionsContentMap } = Object(
          external_wp_element_["useMemo"]
        )(
          () =>
            sections.reduce(
      ...
      /* harmony default export */ var browser_url = Object(
        ...
        const { getCurrentPost, isSavingPost } = select(
          external_wp_editor_["store"]
        );
      ...
      function FullscreenModeClose(_ref) {
        ...
        const { isActive, isRequestingSiteIcon, postType, siteIconUrl } =
          Object(external_wp_data_["useSelect"])((select) => {
      ...
      /* harmony default export */ var fullscreen_mode_close =
        FullscreenModeClose;
      ...
      function HeaderToolbar() {
        ...
        const isWideViewport = Object(external_wp_compose_["useViewportMatch"])(
          "wide"
        );
        /* translators: accessibility text for the editor toolbar */

        const toolbarAriaLabel = Object(external_wp_i18n_["__"])(
          "Document tools"
        );
    ...
    characters. */
      ...
      function ModeSwitcher() {
        const {
          ...
          (select) => ({
            ...
            isCodeEditingEnabled: select(
              external_wp_editor_["store"]
            ).getEditorSettings().codeEditingEnabled,
      ...
      function PostPublishButtonOrToggle(_ref) {
        ...
        const isSmallerThanMediumViewport = Object(
          external_wp_compose_["useViewportMatch"]
        )("medium", "<");
        let component;
        /**
      ...
      function DeleteTemplate() {
        ...
        const { updateEditorSettings, editPost } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_editor_["store"]);
        const { deleteEntityRecord } = Object(external_wp_data_["useDispatch"])(
          external_wp_coreData_["store"]
        );
        const { template } = Object(external_wp_data_["useSelect"])(
          (select) => {
            ...
            external_wp_components_["MenuItem"],
            {
              ...
              onClick: () => {
                if (
                  ...
                  const newAvailableTemplates = Object(
                    external_lodash_["pickBy"]
                  )(settings.availableTemplates, (_title, id) => {
      ...
      function EditTemplateTitle() {
        ...
        const { updateEditorSettings } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_editor_["store"]);
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["TextControl"],
          {
            ...
            onChange: (newTitle) => {
              ...
              )(settings.availableTemplates, (existingTitle, id) => {
                if (id !== template.slug) {
      ...
      function TemplateDescription() {
        const { description, title } = Object(external_wp_data_["useSelect"])(
          (select) => {
            const { getEditedPostTemplate } = select(store["a" /* store */]);
            return {
      ...
      function TemplateTitle() {
        const { template, isEditing, title } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { isEditingTemplate, getEditedPostTemplate } = select(
            store["a" /* store */]
      ...
      function InserterSidebar() {
        const { insertionPoint, showMostUsedBlocks } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
      ...
      const SettingsHeader = (_ref) => {
        ...
        const { documentLabel, isTemplateMode } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const postTypeLabel = select(
            external_wp_editor_["store"]
          ).getPostTypeLabel();
          return {
            ...
            documentLabel:
              postTypeLabel ||
              Object(external_wp_i18n_["_x"])("Document", "noun"),
      ...
      /* harmony default export */ var plugin_post_status_info =
        PluginPostStatusInfo;
      ...
      /* harmony default export */ var taxonomy_panel = Object(
        ...
        Object(external_wp_data_["withSelect"])((select, ownProps) => {
          const slug = Object(external_lodash_["get"])(ownProps.taxonomy, [
            "slug",
          ]);
      ...
      const applyWithSelect = Object(external_wp_data_["withSelect"])(
        (select) => {
          const { getEditedPostAttribute } = select(
            external_wp_editor_["store"]
          );
      ...
      const applyWithDispatch = Object(external_wp_data_["withDispatch"])(
        (dispatch) => {
      ...
      function PageAttributes() {
        const { isEnabled, isOpened, postType } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { getEditedPostAttribute } = select(
            external_wp_editor_["store"]
        ...
        const { toggleEditorPanelOpened } = Object(
          external_wp_data_["useDispatch"]
        )(store["a" /* store */]);
      ...
      class meta_box_visibility_MetaBoxVisibility extends external_wp_element_[
        "Component"
      ] {
        componentDidMount() {
          this.updateDOM();
      ...
      function MetaBoxes(_ref) {
        ...
        const { metaBoxes, areMetaBoxesInitialized, isEditorReady } = Object(
          ...
          (select) => {
            const { __unstableIsEditorReady } = select(
              external_wp_editor_["store"]
            );
            const {
              getMetaBoxesPerLocation,
      ...
      function PluginSidebarEditPost(_ref) {
        ...
        const { postTitle, shortcut, showIconLabels } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          return {
            postTitle: select(
      ...
      function PostTemplateActions() {
        ...
        const [isBusy, setIsBusy] = Object(external_wp_element_["useState"])(
          false
        );
      ...
      function TemplatePanel() {
        const {
          ...
          const _isViewable =
            (_getPostType$viewable =
              (_getPostType = getPostType(currentPostType)) === null ||
              _getPostType === void 0
                ? void 0
                : _getPostType.viewable) !== null &&
            _getPostType$viewable !== void 0
          ...
          const _supportsTemplateMode =
            select(external_wp_editor_["store"]).getEditorSettings()
              .supportsTemplateMode && _isViewable;
          ...
          panelTitle = Object(external_wp_i18n_["sprintf"])(
            ...
            (_template$title =
              template === null || template === void 0
                ? void 0
                : template.title) !== null && _template$title !== void 0
              ? _template$title
              : template.slug
          );
        }
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            external_wp_components_["SelectControl"],
            {
              ...
              label: Object(external_wp_i18n_["__"])("Template:"),
              value: Object.keys(templates).includes(selectedTemplate)
                ? selectedTemplate
                : "",
      ...
      const SettingsSidebar = () => {
        const { sidebarName, keyboardShortcut, isTemplateMode } = Object(
          ...
          if (!["edit-post/document", "edit-post/block"].includes(sidebar)) {
            if (
              select(external_wp_blockEditor_["store"]).getBlockSelectionStart()
            ) {
      ...
      function WelcomeGuide() {
        const { isActive, isTemplateMode } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { isFeatureActive, isEditingTemplate } = select(
            store["a" /* store */]
          );
      ...
      /* harmony default export */ var plugin_pre_publish_panel =
        PluginPrePublishPanel;
      ...
      function ActionsPanel(_ref) {
        ...
        )(() => setEntitiesSavedStatesCallback(true), []); // It is ok for these components to be unmounted when not in visual use.
      ...
      function Layout(_ref) {
        ...
        const {
          ...
          const { getEditorSettings, getPostTypeLabel } = select(
            external_wp_editor_["store"]
          );
                    ...
                    Object(external_wp_element_["createElement"])(
                      ...
                      Object(external_wp_element_["createElement"])(
                        external_wp_components_["Button"],
                        {
                          variant: "secondary",
                          className:
                            "edit-post-layout__toggle-sidebar-panel-button",
      ...
      const useUpdatePostLinkListener = (postId) => {
        const { newPermalink } = Object(external_wp_data_["useSelect"])(
          (select) => ({
            newPermalink: select(external_wp_editor_["store"]).getCurrentPost()
              .link,
          }),
          [postId]
        );
      ...
      function Editor(_ref) {
        let { postId, postType, settings, initialEdits, onError, ...props } =
          _ref;
        const {
          hasFixedToolbar,
          focusMode,
      ...
      /* harmony default export */ var plugin_block_settings_menu_item =
        PluginBlockSettingsMenuItem;
    ...
    /***/ xrib: /***/ function (
      ...
      /* WEBPACK VAR INJECTION */ (function (process) {
        ...
        /* harmony import */ var _wordpress_plugins__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__("TvNi");
        /* harmony import */ var _wordpress_plugins__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(
            _wordpress_plugins__WEBPACK_IMPORTED_MODULE_3__
          );
        /* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__("1ZqX");
        /* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_4___default =
          /*#__PURE__*/ __webpack_require__.n(
            _wordpress_data__WEBPACK_IMPORTED_MODULE_4__
          );
        /* harmony import */ var _wordpress_warning__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__("Z23Y");
        /* harmony import */ var _wordpress_warning__WEBPACK_IMPORTED_MODULE_5___default =
          /*#__PURE__*/ __webpack_require__.n(
