  ...
  /******/ {
    ...
    /***/ "Lb+8": /***/ function (
      ...
      const getGalleryDetailsMediaFrame = () => {
         ...
         *
         * @see https://github.com/xwp/wp-core-media-widgets/blob/905edbccfc2a623b73a93dac803c5335519d7837/4dm1n/js/widgets/media-gallery-widget.js
      ...
      class media_upload_MediaUpload extends external_wp_element_["Component"] {
        ...
        onOpen() {
          ...
          if (!isGallery) {
            Object(external_lodash_["castArray"])(this.props.value).forEach(
              (id) => {
