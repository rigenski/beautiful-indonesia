...
function wp_tinymce_inline_scripts()
{
	...
	/** This filter is documented in 4dm1n/includes/media.php */
...
function wp_default_scripts($scripts)
{
	...
	$scripts->default_dirs    = array('/4dm1n/js/', '/wp-includes/js/');
	...
	$scripts->add('common', "/4dm1n/js/common$suffix.js", array('jquery', 'hoverIntent', 'utils'), false, 1);
	...
	$scripts->add('editor', "/4dm1n/js/editor$suffix.js", array('utils', 'jquery'), false, 1);
	...
	$scripts->add('revisions', "/4dm1n/js/revisions$suffix.js", array('wp-backbone', 'jquery-ui-slider', 'hoverIntent'), false, 1);
	...
	$scripts->add('code-editor', "/4dm1n/js/code-editor$suffix.js", array('jquery', 'wp-codemirror', 'underscore'));
	$scripts->add('wp-theme-plugin-editor', "/4dm1n/js/theme-plugin-editor$suffix.js", array('common', 'wp-util', 'wp-sanitize', 'jquery', 'jquery-ui-core', 'wp-a11y', 'underscore'));
	...
	$scripts->add('password-strength-meter', "/4dm1n/js/password-strength-meter$suffix.js", array('jquery', 'zxcvbn-async'), false, 1);
	did_action('init') && $scripts->localize(
	...
	$scripts->add('application-passwords', "/4dm1n/js/application-passwords$suffix.js", array('jquery', 'wp-util', 'wp-api-request', 'wp-date', 'wp-i18n', 'wp-hooks'), false, 1);
	$scripts->set_translations('application-passwords');

	$scripts->add('auth-app', "/4dm1n/js/auth-app$suffix.js", array('jquery', 'wp-api-request', 'wp-i18n', 'wp-hooks'), false, 1);
	$scripts->set_translations('auth-app');

	$scripts->add('user-profile', "/4dm1n/js/user-profile$suffix.js", array('jquery', 'password-strength-meter', 'wp-util'), false, 1);
	...
	$scripts->add('language-chooser', "/4dm1n/js/language-chooser$suffix.js", array('jquery'), false, 1);

	$scripts->add('user-suggest', "/4dm1n/js/user-suggest$suffix.js", array('jquery-ui-autocomplete'), false, 1);
	...
	$scripts->add('word-count', "/4dm1n/js/word-count$suffix.js", array(), false, 1);

	$scripts->add('media-upload', "/4dm1n/js/media-upload$suffix.js", array('thickbox', 'shortcode'), false, 1);
	...
	$scripts->add('customize-controls', "/4dm1n/js/customize-controls$suffix.js", array('customize-base', 'wp-a11y', 'wp-util', 'jquery-ui-core'), false, 1);
	did_action('init') && $scripts->localize(
		'customize-controls',
	...
	$scripts->add('customize-widgets', "/4dm1n/js/customize-widgets$suffix.js", array('jquery', 'jquery-ui-sortable', 'jquery-ui-droppable', 'wp-backbone', 'customize-controls'), false, 1);
	...
	$scripts->add('customize-nav-menus', "/4dm1n/js/customize-nav-menus$suffix.js", array('jquery', 'wp-backbone', 'customize-controls', 'accordion', 'nav-menu', 'wp-sanitize'), false, 1);
	...
	$scripts->add('accordion', "/4dm1n/js/accordion$suffix.js", array('jquery'), false, 1);
	...
	if (is_admin()) {
		$scripts->add('admin-tags', "/4dm1n/js/tags$suffix.js", array('jquery', 'wp-ajax-response'), false, 1);
		$scripts->set_translations('admin-tags');

		$scripts->add('admin-comments', "/4dm1n/js/edit-comments$suffix.js", array('wp-lists', 'quicktags', 'jquery-query'), false, 1);
		...
		$scripts->add('xfn', "/4dm1n/js/xfn$suffix.js", array('jquery'), false, 1);

		$scripts->add('postbox', "/4dm1n/js/postbox$suffix.js", array('jquery-ui-sortable', 'wp-a11y'), false, 1);
		$scripts->set_translations('postbox');

		$scripts->add('tags-box', "/4dm1n/js/tags-box$suffix.js", array('jquery', 'tags-suggest'), false, 1);
		$scripts->set_translations('tags-box');

		$scripts->add('tags-suggest', "/4dm1n/js/tags-suggest$suffix.js", array('jquery-ui-autocomplete', 'wp-a11y'), false, 1);
		$scripts->set_translations('tags-suggest');

		$scripts->add('post', "/4dm1n/js/post$suffix.js", array('suggest', 'wp-lists', 'postbox', 'tags-box', 'underscore', 'word-count', 'wp-a11y', 'wp-sanitize', 'clipboard'), false, 1);
		$scripts->set_translations('post');

		$scripts->add('editor-expand', "/4dm1n/js/editor-expand$suffix.js", array('jquery', 'underscore'), false, 1);

		$scripts->add('link', "/4dm1n/js/link$suffix.js", array('wp-lists', 'postbox'), false, 1);

		$scripts->add('comment', "/4dm1n/js/comment$suffix.js", array('jquery', 'postbox'), false, 1);
		$scripts->set_translations('comment');

		$scripts->add('admin-gallery', "/4dm1n/js/gallery$suffix.js", array('jquery-ui-sortable'));

		$scripts->add('admin-widgets', "/4dm1n/js/widgets$suffix.js", array('jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable', 'wp-a11y'), false, 1);
		$scripts->set_translations('admin-widgets');

		$scripts->add('media-widgets', "/4dm1n/js/widgets/media-widgets$suffix.js", array('jquery', 'media-models', 'media-views', 'wp-api-request'));
		$scripts->add_inline_script('media-widgets', 'wp.mediaWidgets.init();', 'after');

		$scripts->add('media-audio-widget', "/4dm1n/js/widgets/media-audio-widget$suffix.js", array('media-widgets', 'media-audiovideo'));
		$scripts->add('media-image-widget', "/4dm1n/js/widgets/media-image-widget$suffix.js", array('media-widgets'));
		$scripts->add('media-gallery-widget', "/4dm1n/js/widgets/media-gallery-widget$suffix.js", array('media-widgets'));
		$scripts->add('media-video-widget', "/4dm1n/js/widgets/media-video-widget$suffix.js", array('media-widgets', 'media-audiovideo', 'wp-api-request'));
		$scripts->add('text-widgets', "/4dm1n/js/widgets/text-widgets$suffix.js", array('jquery', 'backbone', 'editor', 'wp-util', 'wp-a11y'));
		$scripts->add('custom-html-widgets', "/4dm1n/js/widgets/custom-html-widgets$suffix.js", array('jquery', 'backbone', 'wp-util', 'jquery-ui-core', 'wp-a11y'));

		$scripts->add('theme', "/4dm1n/js/theme$suffix.js", array('wp-backbone', 'wp-a11y', 'customize-base'), false, 1);

		$scripts->add('inline-edit-post', "/4dm1n/js/inline-edit-post$suffix.js", array('jquery', 'tags-suggest', 'wp-a11y'), false, 1);
		$scripts->set_translations('inline-edit-post');

		$scripts->add('inline-edit-tax', "/4dm1n/js/inline-edit-tax$suffix.js", array('jquery', 'wp-a11y'), false, 1);
		$scripts->set_translations('inline-edit-tax');

		$scripts->add('plugin-install', "/4dm1n/js/plugin-install$suffix.js", array('jquery', 'jquery-ui-core', 'thickbox'), false, 1);
		$scripts->set_translations('plugin-install');

		$scripts->add('site-health', "/4dm1n/js/site-health$suffix.js", array('clipboard', 'jquery', 'wp-util', 'wp-a11y', 'wp-api-request', 'wp-url', 'wp-i18n', 'wp-hooks'), false, 1);
		$scripts->set_translations('site-health');

		$scripts->add('privacy-tools', "/4dm1n/js/privacy-tools$suffix.js", array('jquery', 'wp-a11y'), false, 1);
		$scripts->set_translations('privacy-tools');

		$scripts->add('updates', "/4dm1n/js/updates$suffix.js", array('common', 'jquery', 'wp-util', 'wp-a11y', 'wp-sanitize'), false, 1);
		...
		$scripts->add('farbtastic', '/4dm1n/js/farbtastic.js', array('jquery'), '1.2');

		$scripts->add('iris', '/4dm1n/js/iris.min.js', array('jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch'), '1.1.1', 1);
		$scripts->add('wp-color-picker', "/4dm1n/js/color-picker$suffix.js", array('iris'), false, 1);
		$scripts->set_translations('wp-color-picker');

		$scripts->add('dashboard', "/4dm1n/js/dashboard$suffix.js", array('jquery', 'admin-comments', 'postbox', 'wp-util', 'wp-a11y', 'wp-date'), false, 1);
		$scripts->set_translations('dashboard');

		$scripts->add('list-revisions', "/wp-includes/js/wp-list-revisions$suffix.js");

		$scripts->add('media-grid', "/wp-includes/js/media-grid$suffix.js", array('media-editor'), false, 1);
		$scripts->add('media', "/4dm1n/js/media$suffix.js", array('jquery'), false, 1);
		$scripts->set_translations('media');

		$scripts->add('image-edit', "/4dm1n/js/image-edit$suffix.js", array('jquery', 'jquery-ui-core', 'json2', 'imgareaselect', 'wp-a11y'), false, 1);
		$scripts->set_translations('image-edit');

		$scripts->add('set-post-thumbnail', "/4dm1n/js/set-post-thumbnail$suffix.js", array('jquery'), false, 1);
		 ...
		 */
		$scripts->add('nav-menu', "/4dm1n/js/nav-menu$suffix.js", array('jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable', 'wp-lists', 'postbox', 'json2', 'underscore'));
		$scripts->set_translations('nav-menu');

		$scripts->add('custom-header', '/4dm1n/js/custom-header.js', array('jquery-masonry'), false, 1);
		$scripts->add('custom-background', "/4dm1n/js/custom-background$suffix.js", array('wp-color-picker', 'media-views'), false, 1);
		$scripts->add('media-gallery', "/4dm1n/js/media-gallery$suffix.js", array('jquery'), false, 1);

		$scripts->add('svg-painter', '/4dm1n/js/svg-painter.js', array('jquery'), false, 1);
	}
}
...
function wp_default_styles($styles)
{
	...
	$styles->default_dirs    = array('/4dm1n/', '/wp-includes/css/');
	...
	$styles->add('colors', true, array('4dm1n', 'buttons'));

	$suffix = SCRIPT_DEBUG ? '' : '.min';

	// Admin CSS.
	$styles->add('common', "/4dm1n/css/common$suffix.css");
	$styles->add('forms', "/4dm1n/css/forms$suffix.css");
	$styles->add('admin-menu', "/4dm1n/css/admin-menu$suffix.css");
	$styles->add('dashboard', "/4dm1n/css/dashboard$suffix.css");
	$styles->add('list-tables', "/4dm1n/css/list-tables$suffix.css");
	$styles->add('edit', "/4dm1n/css/edit$suffix.css");
	$styles->add('revisions', "/4dm1n/css/revisions$suffix.css");
	$styles->add('media', "/4dm1n/css/media$suffix.css");
	$styles->add('themes', "/4dm1n/css/themes$suffix.css");
	$styles->add('about', "/4dm1n/css/about$suffix.css");
	$styles->add('nav-menus', "/4dm1n/css/nav-menus$suffix.css");
	$styles->add('widgets', "/4dm1n/css/widgets$suffix.css", array('wp-pointer'));
	$styles->add('site-icon', "/4dm1n/css/site-icon$suffix.css");
	$styles->add('l10n', "/4dm1n/css/l10n$suffix.css");
	$styles->add('code-editor', "/4dm1n/css/code-editor$suffix.css", array('wp-codemirror'));
	$styles->add('site-health', "/4dm1n/css/site-health$suffix.css");

	$styles->add('4dm1n', false, array('dashicons', 'common', 'forms', 'admin-menu', 'dashboard', 'list-tables', 'edit', 'revisions', 'media', 'themes', 'about', 'nav-menus', 'widgets', 'site-icon', 'l10n'));

	$styles->add('login', "/4dm1n/css/login$suffix.css", array('dashicons', 'buttons', 'forms', 'l10n'));
	$styles->add('install', "/4dm1n/css/install$suffix.css", array('dashicons', 'buttons', 'forms', 'l10n'));
	$styles->add('wp-color-picker', "/4dm1n/css/color-picker$suffix.css");
	$styles->add('customize-controls', "/4dm1n/css/customize-controls$suffix.css", array('4dm1n', 'colors', 'imgareaselect'));
	$styles->add('customize-widgets', "/4dm1n/css/customize-widgets$suffix.css", array('4dm1n', 'colors'));
	$styles->add('customize-nav-menus', "/4dm1n/css/customize-nav-menus$suffix.css", array('4dm1n', 'colors'));
	...
	// Deprecated CSS.
	$styles->add('deprecated-media', "/4dm1n/css/deprecated-media$suffix.css");
	$styles->add('farbtastic', "/4dm1n/css/farbtastic$suffix.css", array(), '1.3u1');
	$styles->add('jcrop', '/wp-includes/js/jcrop/jquery.Jcrop.min.css', array(), '0.9.12');
	$styles->add('colors-fresh', false, array('4dm1n', 'buttons')); // Old handle.
...
function wp_localize_community_events()
{
	...
	require_once ABSPATH . '4dm1n/includes/class-wp-community-events.php';
 ...
 *
 * If installing the '4dm1n/' directory will be replaced with './'.
 *
...
function _print_scripts()
{
	...
	if ($concat) {
		...
		$src = $wp_scripts->base_url . "/4dm1n/load-scripts.php?c={$zip}" . $concatenated . '&ver=' . $wp_scripts->default_version;
...
function _print_styles()
{
	...
	if ($concat) {
		...
		$href = $wp_styles->base_url . "/4dm1n/load-styles.php?c={$zip}&dir={$dir}" . $concatenated . '&ver=' . $ver;
