 ...
 * at 4dm1n/network/settings.php. The check is only run on
 * self-registrations; user creation at 4dm1n/network/users.php
 * bypasses this check.
 *
 * @since MU (3.0.0)
 *
 ...
 * Super Admins at 4dm1n/network/settings.php.
 *
 * @since MU (3.0.0)
 *
 * @param array $mimes
...
function get_subdirectory_reserved_names()
{
	 ...
	 *
	 * @since 3.0.0
	 * @since 4.4.0 '4dm1n', 'wp-content', 'wp-includes', 'wp-json', and 'embed' were added
