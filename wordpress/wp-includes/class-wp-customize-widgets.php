...
?>
	...
	public function get_available_widgets()
	{
		...
		require_once ABSPATH . '4dm1n/includes/widgets.php'; // For next_widget_id_number().
...
<?php
	...
	public function wp_ajax_update_widget()
	{
		...
		$is_updating_widget_template = (isset($_POST['widget-' . $id_base])
			&&
	...
	public function filter_dynamic_sidebar_params($params)
	{
		...
		$matches  = array();
		$is_valid = (isset($sidebar_args['id'])
			&&
