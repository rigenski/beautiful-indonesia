...
<?php
	...
	final protected function _render_container($node)
	{
		...
		echo '<div id="' . esc_attr('4dm1n-bar-' . $node->id) . '" class="ab-group-container">';
	...
	final protected function _render_group($node)
	{
		...
		echo "<ul id='" . esc_attr('4dm1n-bar-' . $node->id) . "'$class>";
	...
	final protected function _render_item($node)
	{
		...
		if (!$is_root_top_item && !$is_top_secondary_item && $is_parent) {
			$arrow = '<span class="4dm1n-bar-arrow" aria-hidden="true"></span>';
		}
		...
		echo "<li id='" . esc_attr('4dm1n-bar-' . $node->id) . "'$menuclass>";
