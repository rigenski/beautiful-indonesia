 ...
 * (e.g. wp-blog-header.php or the 4dm1n/ folder) are accessible.
 *
...
{
	$url = get_site_url($blog_id, '4dm1n/', $scheme);
...
function network_admin_url($path = '', $scheme = 'admin')
{
	...
	$url = network_site_url('4dm1n/network/', $scheme);
...
{
	$url = network_site_url('4dm1n/user/', $scheme);
