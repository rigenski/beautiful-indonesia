...
function redirect_canonical($requested_url = null, $do_redirect = true)
{
	...
	// If we're not in 4dm1n and the post has been published and preview nonce
 ...
 *
 * If a user visits example.com/admin, they'll be redirected to /4dm1n.
