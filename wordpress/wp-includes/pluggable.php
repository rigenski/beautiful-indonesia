...
if (!function_exists('auth_redirect')) :
	...
	function auth_redirect()
	{
		...
		if ($secure && !is_ssl() && false !== strpos($_SERVER['REQUEST_URI'], '4dm1n')) {
		...
		if ($user_id) {
			...
			if (!$secure && get_user_option('use_ssl', $user_id) && false !== strpos($_SERVER['REQUEST_URI'], '4dm1n')) {
				if (0 === strpos($_SERVER['REQUEST_URI'], 'http')) {
					wp_redirect(set_url_scheme($_SERVER['REQUEST_URI'], 'https'));
					exit;
				} else {
...
if (!function_exists('wp_safe_redirect')) :
	 ...
	 * list.
	 *
	 * If the host is not allowed, then the redirect defaults to 4dm1n on the siteurl
