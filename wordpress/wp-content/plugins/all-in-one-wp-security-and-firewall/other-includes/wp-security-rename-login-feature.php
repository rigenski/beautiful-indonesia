...
?>
	...
	?>
		...
		<?php
			...
			default:
				...
				if (isset($_REQUEST['redirect_to'])) {
					...
					if ($secure_cookie && false !== strpos($redirect_to, '4dm1n')) {
		...
		<?php
					...
					if ((empty($redirect_to) || '4dm1n/' === $redirect_to || admin_url() === $redirect_to)) {
				...
				if ($interim_login) {
					...
					} elseif (isset($_GET['redirect_to']) && false !== strpos($_GET['redirect_to'], '4dm1n/authorize-application.php')) {
