...
?>
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                ?>
                    <table class="form-table">
                        <?php
                        $edit_user_page = get_option('siteurl') . '/4dm1n/user-edit.php?user_id=';
    ...
    ?>
        ...
        <div class="postbox">
            ...
            <div class="inside">
                <div class="aio_grey_box aio_half_width">
                    <p><?php _e('This password tool uses an algorithm which calculates how long it would take for your password to be cracked using the computing power of an off-the-shelf current model desktop PC with high end processor, graphics card and appropriate password cracking software.', 'all-in-one-wp-security-and-firewall'); ?></p>
                </div>
                ...
                <div id="aiowps_pw_tool_main">
                    <div class="aiowps_password_crack_info_text"><?php _e('It would take a desktop PC approximately', 'all-in-one-wp-security-and-firewall'); ?>
                        <div id="aiowps_password_crack_time_calculation"><?php _e('1 sec', 'all-in-one-wp-security-and-firewall'); ?></div> <?php _e('to crack your password!', 'all-in-one-wp-security-and-firewall'); ?>
                    </div>
                    <!-- The rotating arrow -->
