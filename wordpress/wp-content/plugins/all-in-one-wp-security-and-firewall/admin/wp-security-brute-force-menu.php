...
class AIOWPSecurity_Brute_Force_Menu extends AIOWPSecurity_Admin_Menu
{
    ...
    function render_menu_tabs()
    {
        ...
        foreach ($this->menu_tabs as $tab_key => $tab_caption) {
            if (
                AIOWPSecurity_Utility::is_multisite_install() && get_current_blog_id() != 1
    ...
    function render_tab1()
    {
        ...
        if (isset($_POST['aiowps_save_rename_login_page_settings'])) //Do form submission tasks
        {
            ...
            if (empty($_POST['aiowps_login_page_slug']) && isset($_POST["aiowps_enable_rename_login_page"])) {
                ...
                if ($aiowps_login_page_slug == '4dm1n') {
                    $error .= '<br />' . __('You cannot use the value "4dm1n" for your login page slug.', 'all-in-one-wp-security-and-firewall');
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <form action="" method="POST">
                    ...
                    {
                        if (isset($_REQUEST['aiowps_cookie_test'])) { //Cookie test was just performed and the test succeded
