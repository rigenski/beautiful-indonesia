...
?>
    ...
    function render_tab3()
    {
        ...
        ?>
            ...
            <!--        <div class="postbox">-->
            <!--        <h3 class="hndle"><label for="title">--><?php //_e('View Contents of the currently active wp-config.php file', 'all-in-one-wp-security-and-firewall'); 
                                                                ?>
            <!--</label></h3>-->
            <!--        <div class="inside">-->
            <!--            --><?php
                                ...
                                //            
                                ?>
            <!--            <textarea class="aio_text_area_file_output aio_width_80 aio_spacer_10_tb" rows="20" readonly>--><?php //echo $wp_config_contents; 
                                                                                                                            ?>
            <!--</textarea>-->
            <!--        </div></div>-->
