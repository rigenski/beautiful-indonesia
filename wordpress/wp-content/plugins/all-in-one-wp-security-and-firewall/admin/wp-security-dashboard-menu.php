...
?>
    ...
    function render_tab1()
    {
        ...
        require_once(ABSPATH . '4dm1n/includes/dashboard.php');
    ...
    ?>
        ...
        <div class="postbox">
            <h3 class="hndle"><label for="title"><?php _e('Active Plugins', 'all-in-one-wp-security-and-firewall'); ?></label></h3>
    ...
    ?>
        ...
        <div class="postbox">
            <h3 class="hndle"><label for="title"><?php _e('Currently Locked Out IP Addresses and Ranges', 'all-in-one-wp-security-and-firewall'); ?></label>
            </h3>
    ...
    ?>
        ...
        <div class="postbox">
            <h3 class="hndle"><label for="title"><?php _e('Permanently Blocked IP Addresses', 'all-in-one-wp-security-and-firewall'); ?></label>
            </h3>
    ...
    ?>
        <div class="postbox">
            <h3 class="hndle"><label for="title"><?php _e('View Logs for All In WP Security & Firewall Plugin', 'all-in-one-wp-security-and-firewall'); ?></label>
            </h3>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <select id="aiowps_log_file" name="aiowps_log_file">
                                    ...
                                    <option value="wp-security-log.txt" <?php selected($file_selected, 'wp-security-log.txt'); ?>>
                                        wp-security-log
                                    </option>
                                    <option value="wp-security-log-cron-job.txt" <?php selected($file_selected, 'wp-security-log-cron-job.txt'); ?>>
    ...
    function wp_dashboard_setup()
    {
        ...
        if (
            $aio_wp_security->configs->get_value('aiowps_enable_brute_force_attack_prevention') == '1' ||
        ...
        <script type='text/javascript'>
            ...
            function drawChart() {
                ...
                var options = {
                    width: 320,
                    height: 200,
                    max: <?php echo $total_security_points_achievable; ?>,
                    greenColor: '8EFA9B',
                    yellowColor: 'F5EE90',
                    redColor: 'FA7373',
                    redFrom: 0,
                    ...
                    yellowTo: 50,
                    greenFrom: 50,
                    greenTo: <?php echo $total_security_points_achievable; ?>,
                    minorTicks: 5
                };
    ...
    ?>
        ...
        <p>
            <a href="http://twitter.com/intent/tweet?url=https://www.tipsandtricks-hq.com/wordpress-security-and-firewall-plugin&text=I love the All In One WP Security and Firewall plugin!" target="_blank" class="aio_tweet_link"><?php _e('Post to Twitter', 'all-in-one-wp-security-and-firewall'); ?></a>
        </p>
        <p>
            <a href="http://wordpress.org/support/view/plugin-reviews/all-in-one-wp-security-and-firewall/" target="_blank" class="aio_rate_us_link"><?php _e('Give us a Good Rating', 'all-in-one-wp-security-and-firewall'); ?></a>
        </p>
    <?php
    }
