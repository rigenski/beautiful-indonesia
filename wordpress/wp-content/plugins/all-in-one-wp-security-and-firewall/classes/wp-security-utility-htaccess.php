...
class AIOWPSecurity_Utility_Htaccess
{
    ...
    static function write_to_htaccess()
    {
        ...
        if (!function_exists('get_home_path')) require_once(ABSPATH . '/4dm1n/includes/file.php');
    ...
    static function getrules_enable_brute_force_prevention()
    {
        ...
        if ($aio_wp_security->configs->get_value('aiowps_enable_brute_force_attack_prevention') == '1') {
            ...
            $rules .= 'RewriteCond %{REQUEST_URI} (4dm1n|wp-login)' . PHP_EOL; // If URI contains 4dm1n or wp-login
            if ($aio_wp_security->configs->get_value('aiowps_brute_force_attack_prevention_ajax_exception') == '1') {
                $rules .= 'RewriteCond %{REQUEST_URI} !(4dm1n/admin-ajax.php)' . PHP_EOL; // To allow ajax requests through
            }
    ...
    /*
     * This function will write some directives to allow IPs in the whitelist to access wp-login.php or 4dm1n
