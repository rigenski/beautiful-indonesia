...
class AIOWPSecurity_Process_Renamed_Login_Page
{
    ...
    static function renamed_login_init_tasks()
    {
        ...
        //case where someone attempting to reach 4dm1n
        ...
        if (
            untrailingslashit($parsed_url['path']) === $home_url_with_slug
    ...
    {
        global $wp_query;
        do_action('aiopws_before_set_404'); //This hook is for themes which produce a fatal error when the rename login feature is enabled and someone visits "4dm1n" slug directly
