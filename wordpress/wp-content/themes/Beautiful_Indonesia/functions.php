...
?>
    <style>
        body #login h1 a {
            background-image: url('<?= get_stylesheet_directory_uri() ?>/images/logo.jpg');
            border-radius: 50%;
            background-size: cover;
        }

        body.login {
            background-image: url('<?= get_stylesheet_directory_uri() ?>/images/bg-login.jpg');
            background-size: cover;
        }
    </style>
<?php
...
add_action('login_enqueue_scripts', 'set_logo');
